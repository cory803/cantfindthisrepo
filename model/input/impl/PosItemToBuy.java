...
public class PosItemToBuy extends Input {
	...
	public void handleSyntax(Player player, String syntax) {
		...
		for (PosOffers o : PlayerOwnedShops.SHOPS) {
			...
			for (int q = 0; q<o.getOffers().length; q++) {
				if (o.getOffers()[q].getItemId() == searchedItem) {
					foundOffers.put(new PosDetails(o.getOwner(), o.getCaption()), new PosOffer(o.getOffers()[q].getItemId(), o.getOffers()[q].getAmount(), o.getOffers()[1].getSoldAmount(), o.getOffers()[q].getPrice()));
				}
			}
		}
