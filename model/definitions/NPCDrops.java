...
public class NPCDrops {
	...
	public enum DropChance {
		ALWAYS(0), ALMOST_ALWAYS(2), VERY_COMMON(5), COMMON(15), UNCOMMON(70), NOTTHATRARE(
	...
	public static void drop(Player player, Item item, NPC npc, Position pos,
		...
		if (ItemDropAnnouncer.announce(itemId)) {
			...
			String message = "<img=4><col=009966> " + toGive.getUsername()
	...
	public static class ItemDropAnnouncer {
		...
		private static final int[] TO_ANNOUNCE = new int[] { 
			1543, 1545, 1546, 21074, 21077, 21075, 21076, 21078, 21079, 1547, 1548, 6571, 14484, 4224,
			11702, 11704, 11706, 11708, 11704, 11724, 11726, 11728, 11718,
			11720, 11722, 11730, 11716, 14876, 11286, 13427, 6731, 6737,
			6735, 4151, 21372, 2513, 15259, 13902, 13890, 13884, 13861, 13858,
			...
			11986, 11985, 11984, 11983, 11982, 11981, 11979, 13659, 11235, 13754,
			20000, 20001, 20002, 15103,
			15104, 15105, 15106, 21000, 21001, 21002, 21003, 21004, 21005, 21006, 21007,
			1053, 1830, 1055, 1057, 1831, 1832, 1834, 8000, 21008, 21009, 21010, 21011, 21012, 21013,
			21014, 21015, 21016, 21017, 6564, 6576, 21018, 21019, 21020, 21021, 21022, 21023, 21024, 21025,
			21026, 21027, 21028, 21029, 15017, 21030, 21031, 21032, 21033, 21034, 21035, 21036, 21037,
			21038, 21039, 21040, 21041, 21042, 10330, 10332, 10334, 10336, 10338, 10340, 10342,
			10344, 10346, 10348, 10350, 10352, 21047,21038, 13000, 13001, 13002, 13003, 13004, 13005, 13006, 13007, 13008, 20171};
