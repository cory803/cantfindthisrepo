...
public class Tutorial extends Dialog {
    ...
    public DialogMessage getMessage() {
        switch (getState()) {
            ...
            case 8:
                setState(5);
                return createNpc("Realism is the most prestigious game mode, on Realism you will be playing on 5x exp rates, you also get 15x drop rate, 40% prayer drain rates, and recover spec every 5 seconds!");
            case 9:
                setState(5);
            ...
            case 13:
                setState(6);
                return createNpc("On Ironman you will not be able to use shops or trade with other players. You be on 25x exp rates, 12x drops, 55% prayer drain, and recover spec every 8 seconds!");
            case 14:
