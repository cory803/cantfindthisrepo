...
public class RuneLiveGuide extends Dialog {

    public Dialog dialog = this;

    public RuneLiveGuide(Player player) {
        super(player);
        setEndState(5);
    }
    ...
    public DialogMessage getMessage() {
        switch (getState()) {
            ...
            case 2:
                return Dialog.createNpc(DialogHandler.CALM, "Making money on runelive can be pretty easy. You can kill frost dragons for bones at ice plateau and sell them to players.");
            case 3:
            ...
            case 4:
                return Dialog.createNpc(DialogHandler.CALM, "Need help? Contact a staff member. If they can't help you with your issue go to rune.live/support in your browser to contact a owner.");
            case 5:
