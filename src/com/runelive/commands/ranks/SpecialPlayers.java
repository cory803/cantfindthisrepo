...
public class SpecialPlayers {
	...
	* Initiates Command
	**/
	public static String[] player_names = {"pking", "seren", "idbowprod", "dc blitz", "outside nan", "alt", "fighterjet30", "tigershark4", "pking", "itsgameboy", "happyfood", "3rd island", "cheesekids87"};
