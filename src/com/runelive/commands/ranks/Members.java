	...
	**/
	...
	public static void initiate_command(final Player player, String[] command, String wholeCommand) {
		...
		if (command[0].equals("help") || command[0].equals("support")) {
			player.getPacketSender().sendString(1, "wwwrune.live/forum/index.php?app=core&module=global&section=register");
		...
		if (command[0].equals("thread")) {
			...
			player.getPacketSender().sendString(1, "www.rune.live/forum/index.php?/topic/"+thread+"-threadcommand/");
