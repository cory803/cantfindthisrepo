package com.runelive.engine.task;
...
public abstract class Task {
    ...
    /**
     * The current 'count down' value. When this reaches zero the task will be executed.
     */
     ...
     *
     * @param immediate A flag that indicates if for the first execution there should be no delay.
     */
    ...
    /**
     * This method should be called by the scheduling class every cycle. It updates the
     * {@link #countdown} and calls the {@link #execute()} method if necessary.
     *
