...
/**
 * This utility file is used for name purposes, such as checking if the name is a valid player name
 * upon login and converting the string from a long to a name and vice-versa.
 * 
 * @author relex lawl
 */
...
public class NameUtils {
   ...
   */
  public static final char VALID_PLAYER_CHARACTERS[] = {'_', 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h',
   ...
   */
  public static final char VALID_CHARACTERS[] = {'_', 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i',
