...
public final class NpcAggression {
  ...
  /**
   * Time that has to be spent in a region before npcs stop acting aggressive toward a specific
   * player.
   */
  ...
  public static void target(Player player) {
    ...
    for (NPC npc : player.getLocalNpcs()) {
      ...
      if (Locations.goodDistance(npc.getPosition(), player.getPosition(),
          npc.getAggressionDistance()) || gwdMob) {
