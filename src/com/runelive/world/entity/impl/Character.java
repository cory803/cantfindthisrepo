...
public abstract class Character extends Entity {
  ...
  /*** INSTANCES ***/
  private Direction direction, primaryDirection = Direction.NONE,
      secondaryDirection = Direction.NONE, lastDirection = Direction.NONE;
   ...
   *
   * @return {@code true} if this character needs to reset their movement queue, {@code false}
   * otherwise.
   */
