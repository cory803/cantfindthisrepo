 ...
 * support the storage of elements with a value of {@code null}, and maintains an extremely strict
 * ordering of the elements. This list for storing characters will be blazingly faster than typical
 * implementations, mainly due to the fact that it uses a {@link Queue} to cache the slots that
 * characters are removed from in order to reduce the amount of lookups needed to add a new
 * character.
 *
...
public final class CharacterList<E extends Character> implements Iterable<E> {
    ...
    /**
     * The queue containing all of the slots that {@link CharacterList}s were recently removed from.
     * This is used to reduce slot lookup times for characters being added to this character list.
     */
     ...
     * {@inheritDoc}
     * <p>
     * This implementation will exclude all elements with a value of {@code null} to avoid
    ...
    /**
     * Searches the backing array for the first element encountered that matches {@code filter}. This
     * does not include elements with a value of {@code null}.
     *
     * @param filter the predicate that the search will be based on.
     * @return an optional holding the found element, or an empty optional if no element was found.
     */
     ...
     * @return the element on the given slot or {@code null} if no element is on the spot.
     */
    ...
    /**
     * Searches through the backing array for the next available slot. This method will perform in
     * constant time if the {@code removeSlots} list has a size greater than {@code 0}.
     *
    ...
    /**
     * Removes all of the elements in this collection and resets the {@link CharacterList#characters}
     * and {@link CharacterList#size}.
     */
    @SuppressWarnings("unchecked")
    public void clear() {
        forEach(this::remove);
    ...
    /**
     * An {@link Iterator} implementation that will iterate over the elements in a character list.
     *
