...
public class Graveyard {
  ...
  public static boolean handleDeath(Player player, NPC npc) {
    ...
    if (amount > 0) {
      GroundItemManager.spawnGroundItem(player, new GroundItem(new Item(14667), npc.getPosition(),
          player.getUsername(), false, 150, false, -1));

      if (player.getMinigameAttributes().getGraveyardAttributes()
          .decrementAndGetRequiredKills() <= 0) {
