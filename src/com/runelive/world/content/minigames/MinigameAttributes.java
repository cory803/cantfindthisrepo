...
public class MinigameAttributes {
  ...
  private final BarrowsMinigameAttributes barrowsMinigameAttributes =
      new BarrowsMinigameAttributes();
  ...
  /*
   * public class SoulWarsAttributes { private int activity = 30; private int productChosen = -1;
   * private int team = -1; public int getActivity() { return activity; } public void
   * setActivity(int activity) { this.activity = activity; } public int getProductChosen() { return
   * productChosen; } public void setProductChosen(int prodouctChosen) { this.productChosen =
   * prodouctChosen; } public int getTeam() { return team; } public void setTeam(int team) {
   * this.team = team; } }
   */
