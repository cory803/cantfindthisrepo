...
public class ClanChat {
  ...
  /**
   * This array contains all the rank requirements needed to be met in order to perform certain
   * actions in this clan chat; see {@link #RANK_REQUIRED_TO_ENTER}, {@link #RANK_REQUIRED_TO_KICK},
   * {@link #RANK_REQUIRED_TO_TALK} and {@link #RANK_REQUIRED_TO_BAN}.
   */
  private final int[] rankReqs =
      {-1, -1, ClanChatRank.CAPTAIN.ordinal(), ClanChatRank.CAPTAIN.ordinal()};
  ...
  /**
   * Gets the array of {@link Rank} requirements in order to do certain actions in the
   * {@link ClanChat}.
   * 
  ...
  public static final int RANK_REQUIRED_TO_ENTER = 0, RANK_REQUIRED_TO_KICK = 1,
      RANK_REQUIRED_TO_TALK = 2, RANK_REQUIRED_TO_BAN = 3;
