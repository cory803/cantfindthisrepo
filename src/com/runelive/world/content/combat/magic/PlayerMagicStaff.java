...
/**
 * A set of constants representing the staves that can be used in place of runes.
 * 
 * @author lare96
 */
public enum PlayerMagicStaff {
  ...
  /**
   * Suppress items in the argued array if any of the items match the runes that are represented by
   * the staff the argued player is wielding.
   * 
