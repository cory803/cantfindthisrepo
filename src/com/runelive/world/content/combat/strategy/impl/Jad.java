...
public class Jad implements CombatStrategy {
  ...
  public boolean customContainerAttack(Character entity, Character victim) {
    ...
    if (random <= 8 && Locations.goodDistance(jad.getPosition().getX(), jad.getPosition().getY(),
      ...
      jad.getCombatBuilder()
          .setContainer(new CombatContainer(jad, victim, 1, 2, CombatType.MELEE, true));
    } else if (random <= 4 || !Locations.goodDistance(jad.getPosition().getX(),
        jad.getPosition().getY(), victim.getPosition().getX(), victim.getPosition().getY(), 14)) {
      jad.getCombatBuilder()
          .setContainer(new CombatContainer(jad, victim, 1, 6, CombatType.MAGIC, true));
      ...
      jad.getCombatBuilder()
          .setContainer(new CombatContainer(jad, victim, 1, 5, CombatType.RANGED, true));
