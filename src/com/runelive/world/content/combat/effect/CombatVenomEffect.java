...
public class CombatVenomEffect extends Task {
   ...
   * 
   * @param entity the entity being inflicted with venom.
   */
  ...
  public enum VenomType {
     ...
     * 
     * @param damage the starting damage for this venom type.
     */
  ...
  public void execute() {
    ...
    entity.dealDamage(
        new Hit(entity.getAndDecrementVenomDamage(), Hitmask.DARK_GREEN, CombatIcon.NONE));
    /*
     * if(entity.isPlayer()) { ((Player)entity).getPacketSender().sendInterfaceRemoval(); }
     */
  }
  ...
  public static final class CombatVenomData {
     ...
     * 
     * @param item the item to get the venom type of.
     * 
     * @return the venom type of the specified item, or <code>null</code> if the item is not able to
     * venom the victim.
     */
