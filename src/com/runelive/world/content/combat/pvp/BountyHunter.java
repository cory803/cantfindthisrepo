...
public class BountyHunter {
  ...
  public static void process(Player player) {
    ...
    if (System.currentTimeMillis() - player.getPlayerKillingAttributes()
      ...
      player.getPlayerKillingAttributes()
          .setLastTargetPercentageIncrease(System.currentTimeMillis());
    }
  ...
  public static void sequence(Player player) {
    if (player.getPlayerKillingAttributes().getTarget() != null) {
      if (player.getPlayerKillingAttributes().getTarget().getLocation() != Location.WILDERNESS) {
        ...
        if (player.getPlayerKillingAttributes().getTarget().getPlayerKillingAttributes()
            .getSafeTimer() > 0)
          player.getPlayerKillingAttributes().getTarget().getPlayerKillingAttributes()
              .setSafeTimer(player.getPlayerKillingAttributes().getTarget()
                  .getPlayerKillingAttributes().getSafeTimer() - 1);
  ...
  public static boolean checkTarget(Player player, Player target) {
    if (target.getLocation() != null && target.getLocation() == Location.WILDERNESS
        ...
        && target.getIndex() != player.getIndex()
      ...
      return combatDifference <= player.getWildernessLevel()
