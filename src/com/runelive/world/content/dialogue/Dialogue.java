...
public abstract class Dialogue {
  ...
  /**
   * An array containing the item configurations if type is ITEM_STATEMENT. First index contains the
   * itemId, second index contains the itemZoom and the third index contains the dialogue's title.
   * 
   * @return
   */
  public String[] item() {
  ...
  /**
   * Performs a special 'action' such as giving a player an item or teleporting after finishing said
   * dialogue.
   */
