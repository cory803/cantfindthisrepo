    ...
    switch (stage) {
        ...
        dialogue = new Dialogue() {
          ...
          public String[] dialogue() {
            return new String[] {"Enough of the boring stuff, let's show you some creatures!",
                "There are a bunch of bosses to fight in RuneLive.",
      ...
      case 7:
        dialogue = new Dialogue() {
          ...
          @Override
          public String[] dialogue() {
            return new String[] {"Ah.. The Ghost Town..",
                "Here, you can find a bunch of revenants.", "You can also fight other players."};
          };
      ...
      case 8:
        dialogue = new Dialogue() {
          ...
          @Override
          public String[] dialogue() {
            return new String[] {"RuneLive also has a lot of enjoyable minigames.",
      ...
      case 11:
        dialogue = new Dialogue() {
          ...
          @Override
          public String[] dialogue() {
            return new String[] {"RuneLive is a competitive game. Next to you is a scoreboard",
      ...
      case 12:
        dialogue = new Dialogue() {
          ...
          @Override
          public String[] dialogue() {
            return new String[] {"That was almost all.",
                "I just want to remind you to vote for us on various",
                "gaming toplists. To do so, simply use the ::vote command.",
        ...
        dialogue = new Dialogue() {
          ...
          public String[] dialogue() {
            return new String[] {"If you have any more questions, simply use the ::help",
                ...
                "other players for help there too. Have fun playing RuneLive!"};
          };
        ...
        dialogue = new Dialogue() {
          ...
          public void specialAction() {
            ...
            if (ConnectionHandler
                .getStarters(p.getHostAddress()) <= GameSettings.MAX_STARTERS_PER_IP) {
              if (p.getGameMode() != GameMode.NORMAL) {
                ...
                p.getInventory().add(995, 5000000).add(1153, 1).add(1115, 1).add(1067, 1)
            ...
            TaskManager.submit(new Task(20, p, false) {
              ...
              protected void execute() {
                if (p != null && p.isRegistered()) {
                  ...
                  p.getPacketSender().sendMessage("<img=4> @blu@Join 'RuneLive' clan chat for help!");
                }
                stop();
              }
            });
