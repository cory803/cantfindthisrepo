  ...
  public static Dialogue getDialogue(Player player) {
    return new Dialogue() {
      ...
      public String[] dialogue() {
        return new String[] {"Hello adventurer.", "I have travelled all around RuneLive",
            "and can tell about the items I've encountered.",
      ...
      public Dialogue nextDialogue() {
        return new Dialogue() {
          ...
          @Override
          public String[] dialogue() {
            return new String[] {"Hello adventurer.", "I have traveled all around RuneLive",
                "and can tell about the items I've encountered.",
                "Which item would you like to know about?"};
          }
    ...
    return new Dialogue() {
      ...
      public String[] dialogue() {
        return new String[] {"Ah, yes! The " + Misc.formatText(itemName) + ".",
            "I killed " + Misc.anOrA(npcName) + " " + npcName + " once",
            "and received it as a drop.", "Perhaps you should try doing the same?"};
      }
    };
  }
}
