	...
	private static enum ItemForgeData {
		...
		DRAGONSTONE_BOLTS(new Item[] { new Item(9144, 15), new Item(9193, 15) }, new Item(9341, 15),
				new int[] { 9, 80, 5000 }), DIAMOND_BOLTS(new Item[] { new Item(9143, 15), new Item(9192, 15) },
						new Item(9340, 15),
						new int[] { 9, 70, 4000 }), RUBY_BOLTS(new Item[] { new Item(9143, 15), new Item(9191, 15) },
								new Item(9339, 15), new int[] { 9, 60, 2000 }), EMERALD_BOLTS(
										new Item[] { new Item(9142, 15), new Item(9190, 15) }, new Item(9238, 15),
										new int[] { 9, 40, 1000 }), SAPPHIRE_BOLTS(
												new Item[] { new Item(9142, 15), new Item(9189, 15) },
												new Item(9337, 15), new int[] { 9, 30, 500 }),
		...
		DRAGONBONE_HAT(new Item[] { new Item(11601), new Item(14014) }, new Item(11602),
				new int[] { 13, 99, 0 }), DRAGONBONE_MAGE_TOP(new Item[] { new Item(11601), new Item(14015) },
						new Item(11603), new int[] { 13, 99, 0 }), DRAGONBONE_MAGE_BOTTOMS(
								new Item[] { new Item(11601), new Item(14016) }, new Item(11604),
								new int[] { 13, 99, 0 }), DRAGONBONE_MAGE_GLOVES(
										new Item[] { new Item(11601), new Item(6922) }, new Item(11605),
										new int[] { 13, 99, 0 }), DRAGONBONE_MAGE_BOOTS(
												new Item[] { new Item(11601), new Item(20002) }, new Item(11606),
												new int[] { 13, 99, 0 }),

		DRAGONBONE_FULL_HELM(new Item[] { new Item(11601), new Item(14008) }, new Item(11607),
				new int[] { 13, 99, 0 }), DRAGONBONE_PLATEBODY(new Item[] { new Item(11601), new Item(14009) },
						new Item(11608),
						new int[] { 13, 99, 0 }), DRAGONBONE_PLATELEGS(new Item[] { new Item(11601), new Item(14010) },
								new Item(11611), new int[] { 13, 99, 0 }), DRAGONBONE_MELEE_BOOTS(
										new Item[] { new Item(11601), new Item(20000) }, new Item(11610),
										new int[] { 13, 99, 0 }), DRAGONBONE_MELEE_GLOVES(
												new Item[] { new Item(11601), new Item(7462) }, new Item(11609),
												new int[] { 13, 99, 0 }),

		DRAGONBONE_COIF(new Item[] { new Item(11601), new Item(14011) }, new Item(11616),
				new int[] { 13, 99, 0 }), DRAGONBONE_BODY(new Item[] { new Item(11601), new Item(14012) },
						new Item(11618),
						new int[] { 13, 99, 0 }), DRAGONBONE_CHAPS(new Item[] { new Item(11601), new Item(14013) },
								new Item(11615), new int[] { 13, 99, 0 }), DRAGONBONE_RANGED_BOOTS(
										new Item[] { new Item(11601), new Item(20001) }, new Item(11617),
										new int[] { 13, 99, 0 }), DRAGONBONE_RANGED_GLOVES(
												new Item[] { new Item(11601), new Item(2491) }, new Item(11614),
												new int[] { 13, 99, 0 }), DRAGONBONE_SPIRIT_SHIELD(
														new Item[] { new Item(11601), new Item(11613) },
														new Item(21104), new int[] { 13, 99, 0 }),

		/**
		 * Hastas
		 */

		BRONZE_HASTA(new Item[] { new Item(2349), new Item(1237) }, new Item(11367), new int[] { 13, 18, 1750 }), IRON_HASTA(new Item[] { new Item(2351), new Item(1239) }, new Item(11369), new int[] { 13, 33, 2250 }), STEEL_HASTA(new Item[] { new Item(2353), new Item(1241) }, new Item(11371), new int[] { 13, 48, 4350 }), MITHRIL_HASTA(new Item[] { new Item(2359), new Item(1243) }, new Item(11373), new int[] { 13, 68, 6250 }), ADAMANT_HASTA(new Item[] { new Item(2361), new Item(1245) }, new Item(11375), new int[] { 13, 88, 7800 }), RUNE_HASTA(new Item[] { new Item(2363), new Item(1247) }, new Item(11377), new int[] { 13, 96, 8700 }),

		/**
		 * Imbuing rings
		 */
		BERSERKER_RING(new Item[] { new Item(7968), new Item(6737) }, new Item(15220), new int[] { 1, -1, 0 }), ARCHERS_RING(new Item[] { new Item(7968), new Item(6733) }, new Item(15019), new int[] { 1, -1, 0 }), SEERS_RING(new Item[] { new Item(7968), new Item(6731) }, new Item(15018), new int[] { 1, -1, 0 }), WARRIOR_RING(new Item[] { new Item(7968), new Item(6735) }, new Item(15020), new int[] { 1, -1, 0 });
