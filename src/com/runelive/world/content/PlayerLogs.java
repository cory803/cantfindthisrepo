				...
				GameServer.getCharacterPool()
						.executeQuery(
								"INSERT INTO `trades`(`owner`, `collector`, `item name`, `item id`, `item amount`, `time`) VALUES ('"
										...
										+ collector.getUsername().replaceAll("[\"\\\'/]", "") + "','"
										+ traded.getDefinition().getName().replaceAll("[\"\\\'/]", "") + "','"
										+ traded.getId() + "','" + traded.getAmount() + "','" + getTime() + "')",
								new SQLCallback() {
									@Override
									public void queryComplete(ResultSet rs) throws SQLException {
										// Query is complete
			...
			try {
				GameServer.getCharacterPool().executeQuery(
						"INSERT INTO `donations`(`username`, `forumid`, `tokens`, `item name`, `item id`, `item amount`, `ip address`, `serial address`, `time`) VALUES ('"
								...
								+ item.getId() + "','" + item.getAmount() + "','" + player.getHostAddress() + "','"
								+ player.getSerialNumber() + "','" + getTime() + "')",
						new SQLCallback() {
							@Override
							public void queryComplete(ResultSet rs) throws SQLException {
								// Query is complete
				...
				GameServer.getCharacterPool()
						.executeQuery(
								"INSERT INTO `scrolls`(`username`, `tokens`, `forum name`, `ip address`, `serial address`, `time`) VALUES ('"
										...
										+ forumName.replaceAll("[\"\\\'/]", "") + "','" + player.getHostAddress()
										+ "','" + player.getSerialNumber() + "','" + getTime() + "')",
								new SQLCallback() {
									@Override
									public void queryComplete(ResultSet rs) throws SQLException {
			...
			try {
				GameServer.getCharacterPool().executeQuery(
						"INSERT INTO `staking`(`winner`, `looser`, `owner`, `item name`, `item id`, `item amount`, `time`) VALUES ('"
								...
								+ owner.replaceAll("[\"\\\'/]", "") + "','"
								+ winning.getDefinition().getName().replaceAll("[\"\\\'/]", "") + "','"
								+ winning.getId() + "','" + winning.getAmount() + "','" + getTime() + "')",
						new SQLCallback() {
							@Override
							public void queryComplete(ResultSet rs) throws SQLException {
								// Query is complete
			...
			try {
				GameServer.getCharacterPool().executeQuery(
						"INSERT INTO `npcdrops`(`username`, `time`, `ip address`, `serial address`, `item name`, `item id`, `item amount`, `npc name`) VALUES ('"
								...
								+ player.getHostAddress() + "','" + player.getSerialNumber() + "','"
								+ drop.getDefinition().getName().replaceAll("[\"\\\'/]", "") + "','" + drop.getId()
								+ "','" + drop.getAmount() + "','" + npcName.replaceAll("[\"\\\'/]", "") + "')",
						new SQLCallback() {
							@Override
							public void queryComplete(ResultSet rs) throws SQLException {
								// Query is complete
