...
public class BonusManager {
  ...
  public static void update(Player player) {
    ...
    for (int i = 0; i < STRING_ID.length; i++) {
      ...
      player.getPacketSender().sendString(Integer.valueOf(STRING_ID[i][0]),
          STRING_ID[i][1] + ": " + bonuses[i]);
    }
  }
  ...
  private static final String[][] STRING_ID =
      {{"1675", "Stab"}, {"1676", "Slash"}, {"1677", "Crush"}, {"1678", "Magic"}, {"1679", "Range"},

          {"1680", "Stab"}, {"1681", "Slash"}, {"1682", "Crush"}, {"1683", "Magic"},
          {"1684", "Range"}, {"19148", "Summoning"}, {"19149", "Absorb Melee"},
          {"19150", "Absorb Magic"}, {"19151", "Absorb Ranged"},

          {"1686", "Strength"}, {"19152", "Ranged Strength"}, {"1687", "Prayer"},
          {"19153", "Magic Damage"}};

  public static final int ATTACK_STAB = 0, ATTACK_SLASH = 1, ATTACK_CRUSH = 2, ATTACK_MAGIC = 3,
      ATTACK_RANGE = 4,
