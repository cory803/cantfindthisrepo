...
public class PlayerPanel {
    ...
    public static void refreshPanel(Player player) {
        ...
        // player.getPacketSender().sendString(55077, "@or1@Yell channel: "+(player.yellToggle() ?
        // "@gre@ON" : "@red@OFF")+"");
        // player.getPacketSender().sendString(39164, "@or2@Game Music: "+(player.musicActive() ?
        // "@gre@ON" : "@red@OFF")+"");
        // player.getPacketSender().sendString(39165, "@or2@Game Sounds: "+(player.soundsActive() ?
        // "@gre@ON" : "@red@OFF")+"");
        // player.getPacketSender().sendString(39166, "@or2@Hide Familiars: @red@OFF");
        // player.getPacketSender().sendString(39167, "@or2@Exp Lock: "+(player.experienceLocked() ?
        ...
        player.getPacketSender().sendString(55078,
                "@red@Bossing Points:  @gre@" + player.getBossPoints());
        ...
        player.getPacketSender().sendString(55209,
