...
public class Achievements {
	...
	public enum AchievementData {
		...
		ENTER_THE_LOTTERY(Difficulty.EASY, "Enter The Lottery", 37005, null), FILL_WELL_OF_GOODWILL_1M(Difficulty.EASY,
				"Pour 1M Into The Well", 37006,
										...
										null), SMELT_AN_IRON_BAR(Difficulty.EASY, "Smelt An Iron Bar", 37013,
												null), HARVEST_A_CROP(Difficulty.EASY, "Harvest A Crop", 37014,
														null), INFUSE_A_DREADFOWL_POUCH(Difficulty.EASY,
																"Infuse A Dreadfowl Pouch", 37015,
																null), CATCH_A_YOUNG_IMPLING(Difficulty.EASY,
																		"Catch A Young Impling", 37016,
																		null), CRAFT_A_PAIR_OF_LEATHER_BOOTS(
																				Difficulty.EASY,
																				"Craft A Pair of Leather Boots", 37017,
																				null), CLIMB_AN_AGILITY_OBSTACLE(
																						Difficulty.EASY,
																						"Climb An Agility Obstacle",
																						37018,
																						null), FLETCH_SOME_ARROWS(
																								Difficulty.EASY,
																								"Fletch Some Arrows",
																								37019,
																								null), STEAL_A_RING(
																										...
																										null), MIX_A_POTION(
																												...
																												"Mix A Potion",
																												37021,
																												null), RUNECRAFT_SOME_RUNES(
																														Difficulty.EASY,
																														"Runecraft Some Runes",
																														37022,
																														null), BURY_A_BIG_BONE(
																																Difficulty.EASY,
																																"Bury A Big Bone",
																																37023,
		...
		ENTER_THE_LOTTERY_THREE_TIMES(Difficulty.MEDIUM, "Enter The Lottery", 37037,
				new int[] { 3, 1 }), FILL_WELL_OF_GOODWILL_50M(Difficulty.MEDIUM, "Pour 50M Into The Well", 37038,
						new int[] { 4, 50000000 }), CUT_100_MAGIC_LOGS(Difficulty.MEDIUM, "Cut 100 Magic Logs", 37039,
								new int[] { 5, 100 }), BURN_100_MAGIC_LOGS(Difficulty.MEDIUM, "Burn 100 Magic Logs",
										37040, new int[] { 6, 100 }), FISH_25_ROCKTAILS(Difficulty.MEDIUM,
												"Fish 25 Rocktails", 37041, new int[] { 7, 25 }), COOK_25_ROCKTAILS(
														Difficulty.MEDIUM, "Cook 25 Rocktails", 37042,
														new int[] { 8, 25 }), MINE_25_RUNITE_ORES(Difficulty.MEDIUM,
																"Mine 25 Runite Ores", 37043,
																new int[] { 9, 25 }), SMELT_25_RUNE_BARS(
																		Difficulty.MEDIUM, "Smelt 25 Rune Bars", 37044,
																		new int[] { 10, 25 }), HARVEST_10_TORSTOLS(
																				Difficulty.MEDIUM,
																				"Harvest 10 Torstols", 37045,
																				new int[] { 11,
																						10 }), INFUSE_25_TITAN_POUCHES(
																								Difficulty.MEDIUM,
																								"Infuse 25 Steel Titans",
																								37046,
																								new int[] { 12,
																										25 }), CATCH_5_KINGLY_IMPLINGS(
																												Difficulty.MEDIUM,
																												"Catch 5 Kingly Implings",
																												37047,
																												new int[] {
																														13,
																														5 }), COMPLETE_A_HARD_SLAYER_TASK(
																																Difficulty.MEDIUM,
		...
		FILL_WELL_OF_GOODWILL_250M(Difficulty.HARD, "Pour 250M Into The Well", 37070,
				new int[] { 25, 250000000 }), CUT_5000_MAGIC_LOGS(Difficulty.HARD, "Cut 2500 Magic Logs", 37071,
						new int[] { 26, 2500 }), BURN_2500_MAGIC_LOGS(Difficulty.HARD, "Burn 2500 Magic Logs", 37072,
								new int[] { 27, 2500 }), FISH_2000_ROCKTAILS(Difficulty.HARD, "Fish 1500 Rocktails",
										37073, new int[] { 28, 1500 }), COOK_1000_ROCKTAILS(Difficulty.HARD,
												"Cook 1000 Rocktails", 37074,
												new int[] { 29, 1000 }), MINE_2000_RUNITE_ORES(Difficulty.HARD,
														"Mine 1000 Runite Ores", 37075,
														new int[] { 30, 1000 }), SMELT_1000_RUNE_BARS(Difficulty.HARD,
																"Smelt 1000 Rune Bars", 37076,
																new int[] { 31, 1000 }), HARVEST_1000_TORSTOLS(
																		Difficulty.HARD, "Harvest 1000 Torstols", 37077,
																		new int[] { 32,
																				1000 }), INFUSE_500_STEEL_TITAN_POUCHES(
																						Difficulty.HARD,
																						"Infuse 500 Steel Titans",
																						37078,
																						new int[] { 33,
																								500 }), CRAFT_1000_DIAMOND_GEMS(
																										Difficulty.HARD,
																										"Craft 750 Diamond Gems",
																										37079,
																										new int[] { 34,
																												750 }), CATCH_100_KINGLY_IMPLINGS(
																														Difficulty.HARD,
																														"Catch 100 Kingly Imps",
																														37080,
																														new int[] {
																																35,
																																100 }), FLETCH_5000_RUNE_ARROWS(
																																		Difficulty.HARD,
																																		"Fletch 5000 Rune Arrows",
																																		37081,
																																		new int[] {
																																				36,
																																				5000 }), STEAL_5000_SCIMITARS(
																																						Difficulty.HARD,
																																						"Steal 2000 Scimitars",
																																						37082,
																																						new int[] {
																																								37,
																																								2000 }), RUNECRAFT_8000_BLOOD_RUNES(
																																										Difficulty.HARD,
																																										"Runecraft 6000 Blood Runes",
																																										37083,
																																										new int[] {
																																												38,
		...
		COMPLETE_ALL_HARD_TASKS(Difficulty.ELITE, "Complete All Hard Tasks", 37104,
				new int[] { 47, 32 }), CUT_AN_ONYX_STONE(Difficulty.ELITE, "Cut An Onyx Stone", 37105,
						null), REACH_MAX_EXP_IN_A_SKILL(Difficulty.ELITE, "Reach Max Exp In A Skill", 37106,
								null), REACH_LEVEL_99_IN_ALL_SKILLS(Difficulty.ELITE, "Reach Level 99 In All Skills",
										37107, new int[] { 48, 23 }), DEFEAT_10000_MONSTERS(Difficulty.ELITE,
												"Defeat 10,000 Monsters", 37108,
												new int[] { 49, 10000 }), DEFEAT_500_BOSSES(Difficulty.ELITE,
														"Defeat 500 Boss Monsters", 37109,
														new int[] { 50, 500 }), VOTE_100_TIMES(Difficulty.ELITE,
																"Vote 100 Times", 37110, new int[] { 51, 100 }),
