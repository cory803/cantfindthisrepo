...
public class Achievements {
	...
	public enum AchievementData {
		...
		ENTER_THE_LOTTERY(Difficulty.EASY, "Enter The Lottery", 37005, null), FILL_WELL_OF_GOODWILL_1M(Difficulty.EASY, "Pour 1M Into The Well", 37006, null),
		...
		FIGHT_ANOTHER_PLAYER(Difficulty.EASY, "Fight Another Player", 37033, null), BURY_A_DRAGON_BONE(Difficulty.EASY, "Bury A Dragon Bone", 37034, null),
		...
		STEAL_5000_SCIMITARS(Difficulty.HARD, "Steal 2000 Scimitars", 37082, new int[] {37, 2000 }),
		...
		REACH_LEVEL_99_IN_ALL_SKILLS(Difficulty.ELITE, "Reach Level 99 In All Skills", 37107, new int[] { 48, 23 }),
