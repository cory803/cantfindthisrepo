...
public class Achievements {
  ...
  public enum AchievementData {
    ...
    ENTER_THE_LOTTERY(Difficulty.EASY, "Enter The Lottery", 37005, null), FILL_WELL_OF_GOODWILL_1M(
        Difficulty.EASY, "Pour 1M Into The Well", 37006,
        null), CUT_AN_OAK_TREE(Difficulty.EASY, "Cut An Oak Tree", 37007, null), BURN_AN_OAK_LOG(
            Difficulty.EASY, "Burn An Oak Log", 37008,
            null), FISH_A_SALMON(Difficulty.EASY, "Fish A Salmon", 37009, null), COOK_A_SALMON(
                Difficulty.EASY, "Cook A Salmon", 37010,
                null), EAT_A_SALMON(Difficulty.EASY, "Eat A Salmon", 37011, null), MINE_SOME_IRON(
                    Difficulty.EASY, "Mine Some Iron", 37012,
                    null), SMELT_AN_IRON_BAR(Difficulty.EASY, "Smelt An Iron Bar", 37013,
                        null), HARVEST_A_CROP(Difficulty.EASY, "Harvest A Crop", 37014,
                            null), INFUSE_A_DREADFOWL_POUCH(Difficulty.EASY,
                                "Infuse A Dreadfowl Pouch", 37015, null), CATCH_A_YOUNG_IMPLING(
                                    Difficulty.EASY, "Catch A Young Impling", 37016,
                                    null), CRAFT_A_PAIR_OF_LEATHER_BOOTS(Difficulty.EASY,
                                        "Craft A Pair of Leather Boots", 37017,
                                        null), CLIMB_AN_AGILITY_OBSTACLE(Difficulty.EASY,
                                            "Climb An Agility Obstacle", 37018,
                                            null), FLETCH_SOME_ARROWS(Difficulty.EASY,
                                                "Fletch Some Arrows", 37019,
                                                null), STEAL_A_RING(Difficulty.EASY, "Steal A Ring",
                                                    37020, null), MIX_A_POTION(Difficulty.EASY,
                                                        "Mix A Potion", 37021,
                                                        null), RUNECRAFT_SOME_RUNES(Difficulty.EASY,
                                                            "Runecraft Some Runes", 37022,
                                                            null), BURY_A_BIG_BONE(Difficulty.EASY,
                                                                "Bury A Big Bone", 37023,
                                                                null), COMPLETE_A_SLAYER_TASK(
                                                                    Difficulty.EASY,
                                                                    "Complete A Slayer Task", 37024,
                                                                    null), SET_UP_A_CANNON(
                                                                        Difficulty.EASY,
                                                                        "Set Up A Cannon", 37025,
                                                                        null), KILL_A_MONSTER_USING_MELEE(
                                                                            Difficulty.EASY,
                                                                            "Kill a Monster Using Melee",
                                                                            37026,
                                                                            null), KILL_A_MONSTER_USING_RANGED(
                                                                                Difficulty.EASY,
                                                                                "Kill a Monster Using Ranged",
                                                                                37027,
                                                                                null), KILL_A_MONSTER_USING_MAGIC(
                                                                                    Difficulty.EASY,
                                                                                    "Kill a Monster Using Magic",
                                                                                    37028,
                                                                                    null), DEAL_EASY_DAMAGE_USING_MELEE(
                                                                                        Difficulty.EASY,
                                                                                        "Deal 1000 Melee Damage",
                                                                                        37029,
                                                                                        new int[] {
                                                                                            0,
                                                                                            1000}), DEAL_EASY_DAMAGE_USING_RANGED(
                                                                                                Difficulty.EASY,
                                                                                                "Deal 1000 Ranged Damage",
                                                                                                37030,
                                                                                                new int[] {
                                                                                                    1,
                                                                                                    1000}), DEAL_EASY_DAMAGE_USING_MAGIC(
                                                                                                        Difficulty.EASY,
                                                                                                        "Deal 1000 Magic Damage",
                                                                                                        37031,
                                                                                                        new int[] {
                                                                                                            2,
                                                                                                            1000}), PERFORM_A_SPECIAL_ATTACK(
                                                                                                                Difficulty.EASY,
                                                                                                                "Perform a Special Attack",
                                                                                                                37032,
                                                                                                                null), FIGHT_ANOTHER_PLAYER(
                                                                                                                    Difficulty.EASY,
                                                                                                                    "Fight Another Player",
                                                                                                                    37033,
                                                                                                                    null), BURY_A_DRAGON_BONE(
                                                                                                                        Difficulty.EASY,
                                                                                                                        "Bury A Dragon Bone",
                                                                                                                        37034,
                                                                                                                        null),

    ENTER_THE_LOTTERY_THREE_TIMES(Difficulty.MEDIUM, "Enter The Lottery", 37037,
        new int[] {3, 1}), FILL_WELL_OF_GOODWILL_50M(Difficulty.MEDIUM, "Pour 50M Into The Well",
            37038, new int[] {4, 50000000}), CUT_100_MAGIC_LOGS(Difficulty.MEDIUM,
                "Cut 100 Magic Logs", 37039, new int[] {5, 100}), BURN_100_MAGIC_LOGS(
                    Difficulty.MEDIUM, "Burn 100 Magic Logs", 37040,
                    new int[] {6, 100}), FISH_25_ROCKTAILS(Difficulty.MEDIUM, "Fish 25 Rocktails",
                        37041, new int[] {7, 25}), COOK_25_ROCKTAILS(Difficulty.MEDIUM,
                            "Cook 25 Rocktails", 37042, new int[] {8, 25}), MINE_25_RUNITE_ORES(
                                Difficulty.MEDIUM, "Mine 25 Runite Ores", 37043,
                                new int[] {9, 25}), SMELT_25_RUNE_BARS(Difficulty.MEDIUM,
                                    "Smelt 25 Rune Bars", 37044,
                                    new int[] {10, 25}), HARVEST_10_TORSTOLS(Difficulty.MEDIUM,
                                        "Harvest 10 Torstols", 37045,
                                        new int[] {11, 10}), INFUSE_25_TITAN_POUCHES(
                                            Difficulty.MEDIUM, "Infuse 25 Steel Titans", 37046,
                                            new int[] {12, 25}), CATCH_5_KINGLY_IMPLINGS(
                                                Difficulty.MEDIUM, "Catch 5 Kingly Implings", 37047,
                                                new int[] {13, 5}), COMPLETE_A_HARD_SLAYER_TASK(
                                                    Difficulty.MEDIUM,
                                                    "Complete A Hard Slayer Task", 37048,
                                                    null), CRAFT_20_BLACK_DHIDE_BODIES(
                                                        Difficulty.MEDIUM,
                                                        "Craft 20 Black D'hide Bodies", 37049,
                                                        new int[] {14, 20}), FLETCH_450_RUNE_ARROWS(
                                                            Difficulty.MEDIUM,
                                                            "Fletch 450 Rune Arrows", 37050,
                                                            new int[] {15,
                                                                450}), STEAL_140_SCIMITARS(
                                                                    Difficulty.MEDIUM,
                                                                    "Steal 140 Scimitars", 37051,
                                                                    new int[] {16,
                                                                        140}), MIX_AN_OVERLOAD_POTION(
                                                                            Difficulty.MEDIUM,
                                                                            "Mix An Overload Potion",
                                                                            37052,
                                                                            null), ASSEMBLE_A_GODSWORD(
                                                                                Difficulty.MEDIUM,
                                                                                "Assemble A Godsword",
                                                                                37053,
                                                                                null), CLIMB_50_AGILITY_OBSTACLES(
                                                                                    Difficulty.MEDIUM,
                                                                                    "Climb 50 Agility Obstacles",
                                                                                    37054,
                                                                                    new int[] {17,
                                                                                        50}), RUNECRAFT_500_BLOOD_RUNES(
                                                                                            Difficulty.MEDIUM,
                                                                                            "Runecraft 500 Blood Runes",
                                                                                            37055,
                                                                                            new int[] {
                                                                                                18,
                                                                                                500}), BURY_25_FROST_DRAGON_BONES(
                                                                                                    Difficulty.MEDIUM,
                                                                                                    "Bury 25 Frost Dragon Bones",
                                                                                                    37056,
                                                                                                    new int[] {
                                                                                                        19,
                                                                                                        25}), FIRE_500_CANNON_BALLS(
                                                                                                            Difficulty.MEDIUM,
                                                                                                            "Fire 500 Cannon Balls",
                                                                                                            37057,
                                                                                                            new int[] {
                                                                                                                20,
                                                                                                                500}), DEAL_MEDIUM_DAMAGE_USING_MELEE(
                                                                                                                    Difficulty.MEDIUM,
                                                                                                                    "Deal 100K Melee Damage",
                                                                                                                    37058,
                                                                                                                    new int[] {
                                                                                                                        21,
                                                                                                                        100000}), DEAL_MEDIUM_DAMAGE_USING_RANGED(
                                                                                                                            Difficulty.MEDIUM,
                                                                                                                            "Deal 100K Ranged Damage",
                                                                                                                            37059,
                                                                                                                            new int[] {
                                                                                                                                22,
                                                                                                                                100000}), DEAL_MEDIUM_DAMAGE_USING_MAGIC(
                                                                                                                                    Difficulty.MEDIUM,
                                                                                                                                    "Deal 100K Magic Damage",
                                                                                                                                    37060,
                                                                                                                                    new int[] {
                                                                                                                                        23,
                                                                                                                                        100000}), DEFEAT_THE_KING_BLACK_DRAGON(
                                                                                                                                            Difficulty.MEDIUM,
                                                                                                                                            "Defeat The King Black Dragon",
                                                                                                                                            37061,
                                                                                                                                            null), DEFEAT_THE_CHAOS_ELEMENTAL(
                                                                                                                                                Difficulty.MEDIUM,
                                                                                                                                                "Defeat The Chaos Elemental",
                                                                                                                                                37062,
                                                                                                                                                null), DEFEAT_A_TORMENTED_DEMON(
                                                                                                                                                    Difficulty.MEDIUM,
                                                                                                                                                    "Defeat A Tormented Demon",
                                                                                                                                                    37063,
                                                                                                                                                    null), DEFEAT_THE_CULINAROMANCER(
                                                                                                                                                        Difficulty.MEDIUM,
                                                                                                                                                        "Defeat The Culinaromancer",
                                                                                                                                                        37064,
                                                                                                                                                        null), DEFEAT_NOMAD(
                                                                                                                                                            Difficulty.MEDIUM,
                                                                                                                                                            "Defeat Nomad",
                                                                                                                                                            37065,
                                                                                                                                                            null), DEFEAT_10_PLAYERS(
                                                                                                                                                                Difficulty.MEDIUM,
                                                                                                                                                                "Defeat 10 Players",
                                                                                                                                                                37066,
                                                                                                                                                                new int[] {
                                                                                                                                                                    24,
                                                                                                                                                                    10}), REACH_A_KILLSTREAK_OF_3(
                                                                                                                                                                        Difficulty.MEDIUM,
                                                                            ...
                                                                            500}), FIRE_5000_CANNON_BALLS(
                                                                                ...
                                                                                new int[] {40,
                                                                                    3000}), MIX_100_OVERLOAD_POTIONS(
                                                                                        ...
                                                                                        new int[] {
                                                                                            41,
                                                                                            100}), COMPLETE_AN_ELITE_SLAYER_TASK(
                                                                                                Difficulty.HARD,
                                                                                                "Complete An Elite Slayer Task",
                                                                                                37087,
                                                                                                null), ASSEMBLE_5_GODSWORDS(
                                                                                                    Difficulty.HARD,
                                                                                                                        ...
                                                                                                                        5000000}), DEAL_HARD_DAMAGE_USING_MAGIC(
                                                                                                                            ...
                                                                                                                            new int[] {
                                                                                                                                ...
                                                                                                                                5000000}), DEFEAT_JAD(
                                                                                                                                    ...
                                                                                                                                    "Defeat Jad",
                                                                                                                                    37092,
                                                                                                                                    null), DEFEAT_BANDOS_AVATAR(
                                                                                                                                        Difficulty.HARD,
                                                                                                                                        "Defeat Bandos Avatar",
                                                                                                                                        37093,
                                                                                                                                        null), DEFEAT_GENERAL_GRAARDOR(
                                                                                                                                            Difficulty.HARD,
                                                                                                                                            "Defeat General Graardor",
                                                                                                                                            37094,
                                                                                                                                            null), DEFEAT_KREE_ARRA(
                                                                                                                                                Difficulty.HARD,
                                                                                                                                                "Defeat Kree'Arra",
                                                                                                                                                37095,
                                                                                                                                                null), DEFEAT_COMMANDER_ZILYANA(
                                                                                                                                                    Difficulty.HARD,
                                                                                                                                                    "Defeat Commander Zilyana",
                                                                                                                                                    37096,
                                                                                                                                                    null), DEFEAT_KRIL_TSUTSAROTH(
                                                                                                                                                        Difficulty.HARD,
                                                                                                                                                        "Defeat K'ril Tsutsaroth",
                                                                                                                                                        37097,
                                                                                                                                                        null), DEFEAT_THE_CORPOREAL_BEAST(
                                                                                                                                                            Difficulty.HARD,
                                                                                                                                                            ...
                                                                                                                                                            null), DEFEAT_NEX(
                                                                                                                                                                ...
                                                                                                                                                                "Defeat Nex",
                                                                                                                                                                37099,
                                                                                                                                                                null), DEFEAT_30_PLAYERS(
                                                                                                                                                                    Difficulty.HARD,
                                                                                                                                                                    "Defeat 30 Players",
                                                                                                                                                                    37100,
                                                                                                                                                                    new int[] {
                                                                                                                                                                        46,
                                                                                                                                                                        30}), REACH_A_KILLSTREAK_OF_6(
                                                                                                                                                                            Difficulty.HARD,
                                                                                                                                                                            "Reach A Killstreak Of 6",
                                                                                                                                                                            37101,
                                                                                                                                                                            null),

    COMPLETE_ALL_HARD_TASKS(Difficulty.ELITE, "Complete All Hard Tasks", 37104,
        new int[] {47, 32}), CUT_AN_ONYX_STONE(Difficulty.ELITE, "Cut An Onyx Stone", 37105,
            null), REACH_MAX_EXP_IN_A_SKILL(Difficulty.ELITE, "Reach Max Exp In A Skill", 37106,
                null), REACH_LEVEL_99_IN_ALL_SKILLS(Difficulty.ELITE,
                    "Reach Level 99 In All Skills", 37107,
                    new int[] {48, 23}), DEFEAT_10000_MONSTERS(Difficulty.ELITE,
                        "Defeat 10,000 Monsters", 37108, new int[] {49, 10000}), DEFEAT_500_BOSSES(
                            Difficulty.ELITE, "Defeat 500 Boss Monsters", 37109,
                            new int[] {50, 500}), VOTE_100_TIMES(Difficulty.ELITE, "Vote 100 Times",
                                37110, new int[] {51, 100}),
...
public static int SIZE = AchievementData.values().length;
  ...
  public static boolean handleButton(Player player, int button) {
    ...
    if (index >= 0 && index < AchievementData.values().length) {
      ...
      if (player.getAchievementAttributes().getCompletion()[achievement.ordinal()]) {
        ...
        player.getPacketSender()
            .sendMessage("<img=4> <col=660000>You have not started the achievement: "
                + achievement.interfaceLine + ".");
      } else {
        ...
        if (progress == 0) {
          ...
          player.getPacketSender().sendMessage(
              "<img=4> <col=FFFF00>Your progress for this achievement is currently at: "
  ...
  public static void updateInterface(Player player) {
    ...
    player.getPacketSender().sendString(37001, "Achievements: "
        + player.getPointsHandler().getAchievementPoints() + "/" + AchievementData.values().length);
  }
