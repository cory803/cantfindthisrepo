...
public class SlayerDialogues {
    ...
    return new Dialogue() {
      ...
      public Dialogue nextDialogue() {
        return new Dialogue() {
          ...
          @Override
          public String[] dialogue() {
            return new String[] {"What's my current assignment?",
  ...
  public static Dialogue receivedTask(final Player player, final SlayerMaster master,
    ...
    return new Dialogue() {
      ...
      public String[] dialogue() {
        ...
        if (player.getSlayer().getLastTask() != SlayerTasks.NO_TASK) {
          ...
          line2 = "assignment is to kill "
                  + amountToKill
                  + " "
                  + Misc.formatText(task.toString().toLowerCase()
                  .replaceAll("_", " ")) + "s.";
        }
  ...
  public static Dialogue totalPointsReceived(final Player player) {
    return new Dialogue() {
      ...
      public String[] dialogue() {
         ...
         * if(player.getSlayerMaster().getTaskLevel() == 2) //hard/elite tasks pointsReceived = 10;
         */
