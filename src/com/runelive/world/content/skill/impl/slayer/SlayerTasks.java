...
public enum SlayerTasks {
   ...
   * Easy tasks
   */
  ROCK_CRAB(SlayerMaster.VANNAKA, 1265, "Aqua Rock Crabs can be found in Relleka.", 2100, new Position(2681, 3715)),
