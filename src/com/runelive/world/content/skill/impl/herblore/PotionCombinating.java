...
public class PotionCombinating {
  ...
  public static void combinePotion(Player p, int firstPotID, int secondPotID) {
    ...
    if (potion == null || !p.getInventory().contains(firstPotID)
        || !p.getInventory().contains(secondPotID))
      return;
  ...
  public static void combineFlask(Player p, int firstPotID, int secondPotID) {
    ...
    if (flask == null || !p.getInventory().contains(firstPotID)
        || !p.getInventory().contains(secondPotID))
      return;
  ...
  public enum CombiningDoses {
    ...
    STRENGTH(119, 117, 115, 113, VIAL, "Strength"), SUPER_STRENGTH(161, 159, 157, 2440, VIAL,
        "Super strength"), ATTACK(125, 123, 121, 2428, VIAL, "Attack"), SUPER_ATTACK(149, 147, 145,
            2436, VIAL,
            "Super attack"), DEFENCE(137, 135, 133, 2432, VIAL, "Defence"), SUPER_DEFENCE(167, 165,
                163, 2442, VIAL, "Super defence"), RANGING_POTION(173, 171, 169, 2444, VIAL,
                    "Ranging"), FISHING(155, 153, 151, 2438, VIAL, "Fishing"), PRAYER(143, 141, 139,
                        2434, VIAL,
                        "Prayer"), ANTIFIRE(2458, 2456, 2454, 2452, VIAL, "Antifire"), ZAMORAK_BREW(
                            193, 191, 189, 2450, VIAL, "Zamorakian brew"), ANTIPOISON(179, 177, 175,
                                2446, VIAL, "Antipoison"), RESTORE(131, 129, 127, 2430, VIAL,
                                    "Restoration"), MAGIC_POTION(3046, 3044, 3042, 3040, VIAL,
                                        "Magic"), SUPER_RESTORE(3030, 3028, 3026, 3024, VIAL,
                                            "Super Restoration"), ENERGY(3014, 3012, 3010, 3008,
                                                VIAL, "Energy"), SUPER_ENERGY(3022, 3020, 3018,
                                                    3016, VIAL, "Super Energy"), AGILITY(3038, 3036,
                                                        3034, 3032, VIAL,
                                                        "Agility"), SARADOMIN_BREW(6691, 6689, 6687,
                                                            6685, VIAL,
                                                            "Saradomin brew"), ANTIPOISON1(5949,
                                                                5947, 5945, 5943, VIAL,
                                                                "Antipoison(+)"), ANTIPOISON2(5958,
                                                                    5956, 5954, 5952, VIAL,
                                                                    "Antipoison(++)"), SUPER_ANTIPOISON(
                                                                        185, 183, 181, 2448, VIAL,
    ...
    /*
     * This is what the data in the above enumeration is, in order. EX: COMBAT(oneDosePotionID,
     * twoDosePotionID, threeDosePotionID, fourDosePotionID, vial, "potionName");
     */
     ...
     * 
     * @param vial - This is referenced from: private static final int VIAL = 227; It's a constant
     * and its value never changes.
     * 
     * @param potionName - This is a string which is used to set a name for the potion. Within an
     * enumeration you can use the name(). method to take the name in-front of the stored data. This
     * however could not be done because of some potion names.
     */

    private CombiningDoses(int oneDosePotionID, int twoDosePotionID, int threeDosePotionID,
        int fourDosePotionID, int vial, String potionName) {
    ...
    private CombiningDoses(int flaskSix, int flaskFive, int flaskFour, int flaskThree, int flaskTwo,
        int flaskOne, int vial, String name) {
     ...
     * 
     * @param id
     * @return The dose that this id represents for this potion, or -1 if it doesn't belong to this
     * potion.
     * @date 2/28/12
     * @author 0021sordna
     */
