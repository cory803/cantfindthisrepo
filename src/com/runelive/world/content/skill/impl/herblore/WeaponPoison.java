...
public class WeaponPoison {
  ...
  /**
   * Represents a weapon that can be poisoned. Stores the initial weapon item id, the type of poison
   * used on the weapon and the new poisoned weapon that will be obtained.
   * 
   */
  private enum Weapon {
    /**
  ...
  /**
   * Starts the weapon poison event for each individual weapon item from the enumeration
   * <code>Weapon</code>.
   * 
