...
public class RunecraftingData {
  ...
  public enum TalismanData {
    ...
    AIR_TALISMAN(1438, 1, new Position(2841, 4828)), MIND_TALISMAN(1448, 2, new Position(2793,
        4827)), WATER_TALISMAN(1444, 5, new Position(3482, 4834)), EARTH_TALISMAN(1440,
            9,
                            ...
                            1462, 44, new Position(2400, 4834)), LAW_TALISMAN(1458, 54,
                                new Position(2464, 4817)), DEATH_TALISMAN(1456, 65,
                                    new Position(2208, 4829)), BLOOD_TALISMAN(1450, 77,
                                        new Position(2468, 4888, 1)), ARMADYL_TALISMAN(1460, 77,
                                            new Position(2465, 4771));
