...
public class DesoSpan {
	...
	enum Energy {
		GREEN_ENERGY(8028, 40, 1754, 12, 551, 999), YELLOW_ENERGY(8022, 72, 14, 913, 554, 1006);
		...
		if (energyType != null) {
			...
			player.setCurrentTask(new Task(cycle, player, false) {
				...
				public void execute() {
					...
					if (Misc.getRandom(Skillcape_Data.RUNECRAFTING.isWearingCape(player)
							|| Skillcape_Data.MASTER_RUNECRAFTING.isWearingCape(player) ? 50 : 30) <= 10) {
