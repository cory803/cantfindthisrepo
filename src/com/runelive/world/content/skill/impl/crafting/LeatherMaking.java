...
import com.runelive.model.input.impl.EnterAmountOfLeatherToCraft;
...
public class LeatherMaking {
  ...
  public static void craftLeatherDialogue(final Player player, final int itemUsed,
      final int usedWith) {
    ...
    if (l.getLeather() == player.getSelectedSkillingItem()) {
      if (player.getSkillManager().getCurrentLevel(Skill.CRAFTING) < l.getLevel()) {
        player.getPacketSender().sendMessage(
            "You need a Crafting level of at least " + l.getLevel() + " to make this.");
        return;
      }
