...
import com.runelive.model.input.impl.EnterAmountOfBarsToSmelt;
...
public class SmithingData {
  ...
  public static final int[][] SmeltData = {{2349, 438, 436, 1, 120}, // Bronze bar
      {2351, 440, -1, 15, 540}, // Iron bar
      {2355, 442, -1, 20, 725}, // Silver bar
      {2353, 440, 453, 30, 1350}, // Steel bar
      {2357, 444, -1, 40, 2400}, // Gold bar
      {2359, 447, 453, 50, 3450}, // Mithril bar
      {2361, 449, 453, 70, 4500}, // Adamantite bar
      {2363, 451, 453, 85, 5560} // Runite bar
  };
  ...
  public static boolean canSmelt(Player player, int barId) {
    if (getLevelReq(barId) > player.getSkillManager().getMaxLevel(Skill.SMITHING)) {
      player.getPacketSender().sendMessage(
          "You need a Smithing level of at least " + getLevelReq(barId) + " to make this bar.");
      return false;
    }
    if (!hasOres(player, barId)) {
      ...
      } else if (player.getOres()[0] > 0 && player.getOres()[1] == 453) { // The bar uses custom
                                                                          // coal amount
        requirement = "To make " + anOrA(barId) + " " + new Item(barId).getDefinition().getName()
            + ", you need some "
            + new Item(player.getOres()[0]).getDefinition().getName().replace(" ore", "") + " and "
  ...
  public static void showBronzeInterface(Player player) {
    ...
    player.getPacketSender().sendString(1101,
        GetForlvl(18, player) + "Plate Body" + GetForlvl(18, player));
    player.getPacketSender().sendString(1099,
        GetForlvl(16, player) + "Plate Legs" + GetForlvl(16, player));
    player.getPacketSender().sendString(1100,
        GetForlvl(16, player) + "Plate Skirt" + GetForlvl(16, player));
    player.getPacketSender().sendString(1088,
        GetForlvl(14, player) + "2 Hand Sword" + GetForlvl(14, player));
    player.getPacketSender().sendString(1105,
        GetForlvl(12, player) + "Kite Shield" + GetForlvl(12, player));
    player.getPacketSender().sendString(1098,
        GetForlvl(11, player) + "Chain Body" + GetForlvl(11, player));
    player.getPacketSender().sendString(1092,
        GetForlvl(10, player) + "Battle Axe" + GetForlvl(10, player));
    player.getPacketSender().sendString(1083,
        GetForlvl(9, player) + "Warhammer" + GetForlvl(9, player));
    player.getPacketSender().sendString(1104,
        GetForlvl(8, player) + "Square Shield" + GetForlvl(8, player));
    player.getPacketSender().sendString(1103,
        GetForlvl(7, player) + "Full Helm" + GetForlvl(7, player));
    player.getPacketSender().sendString(1106,
        GetForlvl(7, player) + "Throwing Knives" + GetForlvl(7, player));
    player.getPacketSender().sendString(1086,
        GetForlvl(6, player) + "Long Sword" + GetForlvl(6, player));
    player.getPacketSender().sendString(1087,
        GetForlvl(5, player) + "Scimitar" + GetForlvl(5, player));
    player.getPacketSender().sendString(1108,
        GetForlvl(5, player) + "Arrowtips" + GetForlvl(5, player));
    player.getPacketSender().sendString(1085,
        GetForlvl(4, player) + "Sword" + GetForlvl(4, player));
    player.getPacketSender().sendString(1107,
        GetForlvl(4, player) + "Bolts" + GetForlvl(4, player));
    player.getPacketSender().sendString(13358,
        GetForlvl(4, player) + "Nails" + GetForlvl(4, player));
    player.getPacketSender().sendString(1102,
        GetForlvl(3, player) + "Medium Helm" + GetForlvl(3, player));
    player.getPacketSender().sendString(1093, GetForlvl(2, player) + "Mace" + GetForlvl(2, player));
    player.getPacketSender().sendString(1094,
        GetForlvl(1, player) + "Dagger" + GetForlvl(1, player));
    player.getPacketSender().sendString(1091,
        GetForlvl(1, player) + "Hatchet" + GetForlvl(1, player));
    player.getPacketSender().sendString(8429,
        GetForlvl(8, player) + "Claws" + GetForlvl(8, player));
  ...
  public static void makeIronInterface(Player player) {
    ...
    player.getPacketSender().sendString(11459, oneb + "1 Bar" + oneb);
    player.getPacketSender().sendString(1101,
        GetForlvl(33, player) + "Plate Body" + GetForlvl(18, player));
    player.getPacketSender().sendString(1099,
        GetForlvl(31, player) + "Plate Legs" + GetForlvl(16, player));
    player.getPacketSender().sendString(1100,
        GetForlvl(31, player) + "Plate Skirt" + GetForlvl(16, player));
    ...
    sendString(player, (GetForlvl(26, player) + "Oil Lantern Frame" + GetForlvl(11, player)),
        11461);
  ...
  public static boolean ironOreSuccess(Player player) {
    return Misc
        .getRandom((int) (1 + player.getSkillManager().getCurrentLevel(Skill.SMITHING) / 0.5)) > 5;
  }
}
