...
import com.runelive.world.content.skill.impl.farming.seed.TreeSeedType;
			...
			if (seedType != null) {	
				...
				TaskManager.submit(new Task(2) {
					...
					public void execute() {
						...
						newPatch.setProduct(finalSeedType.getRewards()[0].copy().setAmount(Misc.inclusiveRandom(4, 18)));
