	...
	public static enum Trees {
		NORMAL(1, 1000, 1511,
				new int[] { 1276, 1277, 1278, 1279, 1280, 1282, 1283, 1284, 1285, 1286, 1289, 1290, 1291, 1315, 1316,
						...
						5903, 5904 },
				4, false), ACHEY(1, 1000, 2862, new int[] { 2023 }, 4, false), OAK(15, 1480, 1521,
						new int[] { 1281, 3037 }, 5,
						true), WILLOW(30, 2680, 1519, new int[] { 1308, 5551, 5552, 5553 }, 6, true), TEAK(35, 3400,
								6333, new int[] { 9036 }, 7, true), DRAMEN(36, 6581, 771, new int[] { 1292 }, 7,
										true), MAPLE(45, 4000, 1517, new int[] { 1307, 4677 }, 7, true), MAHOGANY(50,
												5000, 6332, new int[] { 9034 }, 7,
												true), YEW(60, 6160, 1515, new int[] { 1309 }, 8, true), MAGIC(75,
														10000, 1513, new int[] { 1306 }, 9, true), CURSED_MAGIC(75,
																10000, 1514, new int[] { 37821 }, 9, true), EVIL_TREE(
																		80, 11000, 14666, new int[] { 11434 }, 9, true);
