...
public enum BowData {
  ...
  SHORTBOW(1511, 50, 100, 5), LONGBOW(1511, 48, 150, 10),

  OAK_SHORTBOW(1521, 54, 270, 20), OAK_LONGBOW(1521, 56, 350, 25),

  WILLOW_SHORTBOW(1519, 60, 590, 35), WILLOW_LONGBOW(1519, 58, 620, 40),

  MAPLE_SHORTBOW(1517, 64, 910, 50), MAPLE_LONGBOW(1517, 62, 980, 55),

  YEW_SHORTBOW(1515, 68, 1480, 65), YEW_LONGBOW(1515, 66, 1650, 70),

  MAGIC_SHORTBOW(1513, 72, 2130, 80), MAGIC_LONGBOW(1513, 70, 2280, 85);
