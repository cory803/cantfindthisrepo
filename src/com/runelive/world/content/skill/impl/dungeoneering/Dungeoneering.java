...
public class Dungeoneering {
	...
	public static void start(final Player p) {
		...
		party.setDeaths(0);
		party.setKills(0);
		party.sendMessage("Welcome to Dungeoneering floor " + (party.getDungeoneeringFloor().ordinal() + 1)
	...
	private static final Item[] misc = { new Item(555, 121), new Item(14484, 1), new Item(557, 87), new Item(554, 81),
			new Item(565, 63), new Item(5678), new Item(560, 97), new Item(861, 1), new Item(892, 127),
			new Item(1305, 1), new Item(15486, 1), new Item(9185, 1), new Item(18161, 2), new Item(18159, 2),
			new Item(139, 1) };
	...
	public static void handleNpcDeath(Player p, NPC n) {
		if (n.getPosition().getZ() == p.getPosition().getZ()) {
			...
			if (random >= 20 && random <= 45 || boss) {
				GroundItemManager.spawnGroundItem(p, new GroundItem(new Item(ItemBinding.getRandomBindableItem()),
				...
				GroundItemManager.spawnGroundItem(p, new GroundItem(new Item(18201, amt), n.getPosition().copy(),
