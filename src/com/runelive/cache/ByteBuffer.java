...
public final class ByteBuffer {
    ...
    public int getUSmart2() {
        ...
        int lastVal1;
        for(boolean lastVal = false; (lastVal1 = this.getUnsignedSmart()) == 32767; baseVal += 32767) {
            ;
        }
    ...
    public int getSmart() {
        ...
        return i < 128?this.getUnsignedByte() - 64:this.getUnsignedShort() - '쀀';
    }

    public int getUnsignedSmart() {
        int i = this.buffer[this.position] & 255;
        return i < 128?this.getUnsignedByte():this.getUnsignedShort() - '耀';
    }
