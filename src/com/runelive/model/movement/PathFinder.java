...
public class PathFinder {
  ...
  public static void findPath(Character gc, int destX, int destY, boolean moveNear, int xLength,
      int yLength) {
    try {
      if (destX == gc.getPosition().getLocalX() && destY == gc.getPosition().getLocalY()
          && !moveNear) {
        return;
      }
      ...
      System.out.println(
          "Error finding route, destx: " + destX + ", destY: " + destY + ". Reseted queue.");
