...
import static com.runelive.model.Direction.EAST;
import static com.runelive.model.Direction.NORTH;
import static com.runelive.model.Direction.NORTH_EAST;
import static com.runelive.model.Direction.NORTH_WEST;
import static com.runelive.model.Direction.SOUTH;
import static com.runelive.model.Direction.SOUTH_EAST;
import static com.runelive.model.Direction.SOUTH_WEST;
import static com.runelive.model.Direction.WEST;
...
public final class MovementQueue {
	 ...
	 *            X to walk to
	 * @param y
	 *            Y to walk to Can the step walk through objects?
	 */
			...
			followTask = new Task(1, character, true) {
				...
				public void execute() {
					...
					if (character.isNpc() && ((NPC) character).isSummoningNpc()
							&& (followCharacter.getLocation() == Location.BANK
						...
						Direction dir = Direction.direction(character.getPosition().getX(),
								followCharacter.getPosition().getX(), character.getPosition().getY(),
								followCharacter.getPosition().getY());
						int xDiff = 0;// Math.abs(followCharacter.getPosition().getX()
										// - character.getPosition().getX());
						int yDiff = 0;// Math.abs(followCharacter.getPosition().getY()
						...
						// System.out.println("xDiff: " + xDiff + ", yDiff: " +
						// yDiff + ", xDiff > yDiff: " + (xDiff > yDiff));
						// System.out.println("offsetX: " + offsetX + ",
						// offsetY: " + offsetY);
						PathFinder.findPath(character, followCharacter.getPosition().getX() + offsetX,
								followCharacter.getPosition().getY() + offsetY, true, size, size, true);
					}
				}
	...
	public void freeze(int delay) {
		if (character.isFrozen() || (System.currentTimeMillis() - character.getLastFreeze()) < 4000)
			return;
