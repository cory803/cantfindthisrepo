...
public class BuyShards extends EnterAmount {
  ...
  public void handleAmount(Player player, int amount) {
    ...
    } else if (player.getInventory().getAmount(995) >= (long) amount
        * ItemDefinition.forId(18016).getValue()) {
      if (!player.getInventory().hasRoomFor(18016, amount)) {
        player.getPacketSender()
            .sendMessage("You do not have enough inventory space to hold <col=ff0000>"
