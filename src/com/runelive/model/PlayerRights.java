...
public enum PlayerRights {
	...
	PLAYER(), MODERATOR(), ADMINISTRATOR(MODERATOR), OWNER(ADMINISTRATOR, MODERATOR), SUPPORT(), YOUTUBER(), GLOBAL_MOD(
	...
	public boolean inherits(PlayerRights rights) {
		return equals(rights) || Arrays.asList(inherited).contains(rights) || rights.equals(PLAYER)
				|| equals(MODERATOR) && rights.equals(SUPPORT);
	}
	...
	public boolean inherited(PlayerRights rights) {
		return Arrays.asList(inherited).contains(rights) || rights.equals(PLAYER)
				|| equals(MODERATOR) && rights.equals(SUPPORT);
	}
