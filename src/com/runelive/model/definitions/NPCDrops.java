...
public class NPCDrops {
  ...
  public enum DropChance {
    ALWAYS(0), ALMOST_ALWAYS(2), VERY_COMMON(5), COMMON(15), UNCOMMON(70), NOTTHATRARE(100), RARE(
        250), LEGENDARY(
  ...
  /**
   * Drops items for a player after killing an npc. A player can max receive one item per drop
   * chance.
   * 
  ...
  public static void drop(Player player, Item item, NPC npc, Position pos, boolean goGlobal) {
    ...
    if (itemId == CharmingImp.GOLD_CHARM || itemId == CharmingImp.GREEN_CHARM
        || itemId == CharmingImp.CRIM_CHARM || itemId == CharmingImp.BLUE_CHARM) {
    ...
    if (itemId == 18778) { // Effigy, don't drop one if player already has one
      ...
      for (Bank bank : toGive.getBanks()) {
        ...
        if (bank.contains(18778) || bank.contains(18779) || bank.contains(18780)
            || bank.contains(18781)) {
          return;
        }
      }
  ...
  public static class ItemDropAnnouncer {
    ...
    public static final int[] TO_ANNOUNCE = new int[] {21114, 21113, 21112, 21111, 21110, 12703, 1543, 1545, 1546, 21074, 21077, 21075,
        21076, 21078, 21079, 1547, 1548, 6571, 14484, 4224, 11702, 11704, 11706, 12926, 21107, 21108, 21109, 10887, 11708, 11704,
        ...
        13893, 13899, 13873, 13879, 13876, 13870, 6571, 14008, 14009, 14010, 14011, 14012, 14013,
        14014, 14015, 14016, 13750, 13748, 13746, 13752, 11335, 15486, 13870, 13873, 13876, 13884,
        13890, 13896, 13902, 13858, 13861, 13864, 13867, 11995, 11996, 11997, 11978, 12001, 12002,
        12003, 12004, 12005, 12006, 11990, 11991, 11992, 11993, 11994, 11989, 11988, 11987, 11986,
        11985, 11984, 11983, 11982, 11981, 11979, 13659, 11235, 13754, 20000, 20001, 20002, 15103,
        15104, 15105, 15106, 21000, 21001, 21002, 21003, 21004, 21005, 21006, 21007, 1053, 1830,
        1055, 1057, 1831, 1832, 1834, 8000, 21008, 21009, 21010, 21011, 21012, 21013, 21014, 21015,
        21016, 21017, 6564, 6576, 21018, 21019, 21020, 21021, 21022, 21023, 21024, 21025, 21026,
        21027, 21028, 21029, 15017, 21030, 21031, 21032, 21033, 21034, 21035, 21036, 21037, 21038,
        21039, 21040, 21041, 21042, 10330, 10332, 10334, 10336, 10338, 10340, 10342, 10344, 10346,
        10348, 10350, 10352, 21047, 21038, 13000, 13001, 13002, 13003, 13004, 13005, 13006, 13007,
        13008, 20171, 21089, 21090, 21103, 21091, 21092, 21100, 21101, 15259, 15241, 13576, 21104,
        19672, 19673, 19674, 21111, 21112, 21113, 11694, 14004, 14005, 14006, 14007};
