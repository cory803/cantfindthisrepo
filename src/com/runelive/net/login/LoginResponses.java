...
public final class LoginResponses {
    ...
    /**
     * This opcode is used for data (session keys, name, password, etc) exchange.
     */
    public static final int LOGIN_EXCHANGE_DATA = 0;

    /**
     * This login opcode is used for a 2000ms delay, after which a reconnection is attempted.
     */
    ...
    /**
     * This login opcode is used when the player has entered an invalid username and/or password.
     */
    ...
    /**
     * This login opcode is used when the account attempting to connect is already online in the
     * server.
     */
    ...
    /**
     * This login opcode is used when a non-member player is attempting to login to a members world.
     */
    public static final int LOGIN_WORLD_MEMBER_ACCOUNT_REQUIRED = 12;

    /**
     * This login opcode is used when the login procedure could not be completed.
     */
    ...
    /**
     * This login opcode is received upon a reconnection so that chat messages will not dissappear.
     */
    public static final int LOGIN_RECONNECTION = 15;

    /**
     * This login opcode is used when a player has exceeded their attempts to login.
     */
    public static final int LOGIN_EXCESSIVE_ATTEMPTS = 16;

    /**
     * This login opcode is used when a member is attempting to login to a non-members world in a
     * members-only area.
     */
    ...
    /**
     * This login opcode is used when a player has just left another world and has to wait a delay
     * before entering a new world.
     */
    ...
    /**
     * This login opcode is used when a player has attempted to login with a old client.
     */
