...
public final class ConnectionThrottler {
    ...
    public boolean verifyConnection(String host) {
        ...
        /**
         * Check to see how long it's been since the last connection attempt.
         * If less than or equal to 1 second and the total attempts is 5 or more,
    ...
    /**
     * If the connection is still throttled, return true.
     * If the connection shouldn't be throttled anymore, remove reset connection maps for host.
     * @param host
     * @return
     */
    private boolean isThrottled(String host) {
        ...
        log.severe(host + " still throttled. Time since connection throttled: " + (timeSinceThrottled) + "ms, throttle timer: " + (this.throttleTimer * 1000) + "ms");
        return true;
    }
