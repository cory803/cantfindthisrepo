...
/**
 * The {@link Packet} implementation that contains data used for the final portion of the login
 * protocol.
 *
...
public final class LoginDetailsMessage {
     ...
     *
     * @param ctx       the {@link ChannelHandlerContext} that holds our {@link Channel} instance.
     ...
     */
    public LoginDetailsMessage(String username, String password, String host, String cp_address,
                               String mac_address, long serial, String clientVersion, int uid) {
