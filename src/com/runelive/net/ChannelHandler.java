...
/**
 * An implementation of netty's {@link SimpleChannelUpstreamHandler} to handle all of netty's
 * incoming events.
 * 
...
public class ChannelHandler extends IdleStateAwareChannelUpstreamHandler {
  ...
  public void exceptionCaught(ChannelHandlerContext ctx, ExceptionEvent e) {
    if (!(e.getCause() instanceof IOException)) { // Because there's no more data to read (happens
