...
/**
 * This packet listener is called when a player has clicked on another player's menu actions.
 * 
 * @author relex lawl
 */
...
public class PlayerOptionPacketListener implements PacketListener {
  ...
  private static void option1(Player player, Packet packet) {
    ...
    if (victim == null)
      return;
    /*
     * GameServer.getTaskScheduler().schedule(new WalkToTask(player, victim.getPosition(), new
     * FinalizedMovementTask() {
