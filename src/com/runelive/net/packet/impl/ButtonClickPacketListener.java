...
import com.runelive.world.content.dialogue.DialogueOptions;
...
import com.runelive.world.content.skill.impl.dungeoneering.DungeoneeringParty;
    ...
    switch (id) {
      ...
      case -10463:
        ...
        if (player.getSkillManager().getTotalLevel() < tlNeeded) {
          player.getPacketSender().sendMessage("You cannot the players online until you have over "
              + (tlNeeded + 1) + " total level.");
        } else {
      ...
      case -10418:
        if (player.getPlayerKillingAttributes().getTarget() != null) {
          ...
          if (player.getPlayerKillingAttributes().getTarget()
              .getLocation() == Location.WILDERNESS) {
            if (on_eachother) {
      ...
      case 350:
        player.getPacketSender()
            .sendMessage(
                "To autocast a spell, please right-click it and choose the autocast option.")
      ...
      case 30162:
        ...
        break;
      case 8667:
        TeleportHandler.teleportPlayer(player, new Position(2742, 3443),
            player.getSpellbook().getTeleportType());
        break;
      case 8672:
        TeleportHandler.teleportPlayer(player, new Position(2595, 4772),
            player.getSpellbook().getTeleportType());
        player.getPacketSender().sendMessage(
            "<img=4> To get started with Runecrafting, buy a talisman and use the locate option on it.");
        break;
      case 8861:
        TeleportHandler.teleportPlayer(player, new Position(2914, 3450),
            player.getSpellbook().getTeleportType());
        break;
      case 8656:
        ...
        break;
      case 8659:
        TeleportHandler.teleportPlayer(player, new Position(3024, 9741),
            player.getSpellbook().getTeleportType());
        break;
      case 8664:
        TeleportHandler.teleportPlayer(player, new Position(3094, 3501),
            player.getSpellbook().getTeleportType());
        break;
      case 8666:
        TeleportHandler.teleportPlayer(player, new Position(3085, 3496),
            player.getSpellbook().getTeleportType());
        break;
      case 8671:
        ...
        break;
      case 8670:
        TeleportHandler.teleportPlayer(player, new Position(2715, 3493),
            player.getSpellbook().getTeleportType());
        break;
      case 8668:
        TeleportHandler.teleportPlayer(player, new Position(2709, 3437),
            player.getSpellbook().getTeleportType());
        break;
      case 8665:
        TeleportHandler.teleportPlayer(player, new Position(3079, 3495),
            player.getSpellbook().getTeleportType());
        break;
      case 8662:
        TeleportHandler.teleportPlayer(player, new Position(2345, 3698),
            player.getSpellbook().getTeleportType());
        break;
      case 13928:
        TeleportHandler.teleportPlayer(player, new Position(3052, 3304),
            player.getSpellbook().getTeleportType());
        break;
      case 28179:
        TeleportHandler.teleportPlayer(player, new Position(2209, 5348),
            player.getSpellbook().getTeleportType());
        break;
      case 18470:
        TeleportHandler.teleportPlayer(player, new Position(2762, 2782),
            player.getSpellbook().getTeleportType());
        break;
      case 28178:
      ...
      case 13045:
        DialogueManager.sendStatement(player,
            "Please select a skill that you would like to train.");
      ...
      case 22012:
        if (!player.isBanking() || player.getInterfaceId() != 5292)
          return;
        Bank.depositItems(player, id == 27005 ? player.getEquipment() : player.getInventory(),
            false);
        break;
      case 27023:
        if (!player.isBanking() || player.getInterfaceId() != 5292)
