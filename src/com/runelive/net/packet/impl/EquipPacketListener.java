          ...
          if (item != null && id == item.getId()) {
            ...
            if (item.getId() == 21054) {
              if (player.getSkillManager().getExperience(Skill.RANGED) < 500000000) {
                player.getPacketSender().sendMessage(
                    "You need atleast 500 million experience in Range to wear this cape!");
                return;
              }
            }
            if (item.getId() == 21055) {
            ...
            if (item.getId() == 21056) {
              if (player.getSkillManager().getExperience(Skill.MAGIC) < 500000000) {
                player.getPacketSender().sendMessage(
                    "You need atleast 500 million experience in Magic to wear this cape!");
                return;
              }
            }
            if (item.getId() == 21057) {
             ...
             * equipItem.getId() == 14010 || equipItem.getId() == 14011 || equipItem.getId() ==
             * 14012 || equipItem.getId() == 14013 || equipItem.getId() == 14014 ||
             * equipItem.getId() == 14015 || equipItem.getId() == 14016) { int newLevel =
             ...
             * player.getPacketSender().sendMessage("Your new hp is: " +
