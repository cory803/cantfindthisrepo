...
/**
 * The {@link Message} implementation that functions as a dynamic buffer wrapper backed by a
 * {@link ChannelBuffer} that is used for reading and writing data.
 *
...
public final class PacketBuilder {
   ...
   */
  private static final int[] BIT_MASK = {0, 0x1, 0x3, 0x7, 0xf, 0x1f, 0x3f, 0x7f, 0xff, 0x1ff,
  ...
  /**
   * Writes the bytes from the argued buffer into this buffer. This method does not modify the
   * argued buffer, and please do not flip the buffer beforehand.
   *
