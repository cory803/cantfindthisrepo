...
public interface UpdateSequence<T extends Character> {
  /**
   * The first stage of the update sequence that executes processing code and prepares the entity
   * for updating.
   *
  ...
  /**
   * The main stage of the update sequence that performs parallelized updating on the entity.
   *
  ...
  /**
   * The last stage of the update sequence that resets the entity and prepares it for the next
   * cycle.
   *
