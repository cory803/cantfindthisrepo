...
/**
 * A {@link WorldUpdateSequence} implementation for {@link Npc}s that provides code for each of the
 * updating stages. The actual updating stage is not supported by this implementation because npc's
 * are updated for players.
 *
 * @author lare96
 */
