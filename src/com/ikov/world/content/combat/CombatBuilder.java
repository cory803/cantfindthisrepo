...
public class CombatBuilder {
  ...
  /**
   * Resets this combat builder by discarding various values associated with the combat process.
   */
  ...
  /**
   * Performs a search on the <code>damageMap</code> to find which {@link Player} dealt the most
   * damage on this controller.
   * 
   * @param clearMap <code>true</code> if the map should be discarded once the killer is found,
   * <code>false</code> if no data in the map should be modified.
   * @return the player who killed this entity, or <code>null</code> if an npc or something else
   * killed this entity.
   */
  ...
  /**
   * Adds damage to the damage map, as long as the argued amount of damage is above 0 and the argued
   * entity is a player.
   * 
  ...
  public boolean isBeingAttacked() {
    return !character.getLastCombat().elapsed(8000);
  }
  ...
  /**
   * A value held in the damage map for caching damage dealt against an {@link Entity}.
   * 
   * @author lare96
   */
