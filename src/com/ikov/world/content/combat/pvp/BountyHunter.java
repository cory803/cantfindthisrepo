...
public class BountyHunter {
	...
	public static void updateInterface(Player player) {
		player.getPacketSender().sendString(25350, player.getPlayerKillingAttributes().getTarget() != null ? player.getPlayerKillingAttributes().getTarget().getUsername() : "");
		player.getPacketSender().sendString(25354, ""+player.getPlayerKillingAttributes().getTargetPercentage()+"%");
