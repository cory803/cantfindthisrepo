...
public class ChaosElemental implements CombatStrategy {
  ...
  private static enum elementalData {
    MELEE(new Graphic(553, GraphicHeight.HIGH), new Graphic(554, GraphicHeight.MIDDLE),
        null), RANGED(new Graphic(665, GraphicHeight.HIGH), null,
  ...
  public boolean customContainerAttack(Character entity, Character victim) {
    ...
    TaskManager.submit(new Task(1, cE, false) {
      ...
      public void execute() {
        cE.getCombatBuilder()
            .setContainer(new CombatContainer(cE, victim, 1, 2, data.getCombatType(), true));
        ...
        if (Misc.getRandom(50) <= 2) {
          ...
          if (RegionClipping.getClipping(randomX, randomY, 0) == 0) {
            ...
            ((Player) victim).getPacketSender()
                .sendMessage("The Chaos elemental has teleported you away!");
          }
        }
