...
public class CustomObjects {
  ...
  private static final CopyOnWriteArrayList<GameObject> CUSTOM_OBJECTS =
    ...
    switch (handleType.toUpperCase()) {
      case "DELETE":
        for (GameObject objects : CUSTOM_OBJECTS) {
          if (objects.getId() == object.getId()
              && object.getPosition().equals(objects.getPosition())) {
  ...
  public static void objectRespawnTask(Player p, final GameObject tempObject,
      final GameObject mainObject, final int cycles) {
  ...
  public static void globalObjectRespawnTask(final GameObject tempObject,
      final GameObject mainObject, final int cycles) {
  ...
  public static void globalFiremakingTask(final GameObject fire, final Player player,
      final int cycles) {
    ...
    TaskManager.submit(new Task(cycles) {
      ...
      public void execute() {
        ...
        if (player.getInteractingObject() != null
            && player.getInteractingObject().getId() == 2732) {
      ...
      public void stop() {
        ...
        GroundItemManager.spawnGroundItem(player, new GroundItem(new Item(592), fire.getPosition(),
            player.getUsername(), false, 150, true, 100));
      }
    });
  }
  ...
  // NOTE: You must add to the client's customobjects array to make them spawn, this is just
  // clipping!
  private static final int[][] CLIENT_OBJECTS = {
       ...
       * Ezone Ends
       **/
      {-1, 3216, 3436, 0, 0}, {-1, 3207, 3435, 0, 0}, {2213, 3214, 3438, 0, 0},
      {2213, 3213, 3438, 0, 0}, {2213, 3212, 3438, 0, 0}, {2213, 3211, 3438, 0, 0},
       ...
       **/
      {360, 2397, 9886, 4, 1}, {360, 2396, 9886, 4, 1}, {360, 2395, 9886, 4, 1},
      {360, 2394, 9886, 4, 1}, {360, 2393, 9886, 4, 1}, {360, 2392, 9886, 4, 1},
      {360, 2391, 9886, 4, 1}, {360, 2390, 9886, 4, 1}, {360, 2389, 9886, 4, 1},
      {360, 2388, 9886, 4, 1}, {360, 2387, 9886, 4, 1}, {360, 2386, 9886, 4, 1},
      {360, 2385, 9886, 4, 1}, {360, 2384, 9886, 4, 1}, {360, 2383, 9886, 4, 1},
      {360, 2397, 9886, 0, 1}, {360, 2396, 9886, 0, 1}, {360, 2395, 9886, 0, 1},
      {360, 2394, 9886, 0, 1}, {360, 2393, 9886, 0, 1}, {360, 2392, 9886, 0, 1},
      {360, 2391, 9886, 0, 1}, {360, 2390, 9886, 0, 1}, {360, 2389, 9886, 0, 1},
      {360, 2388, 9886, 0, 1}, {360, 2387, 9886, 0, 1}, {360, 2386, 9886, 0, 1},
      {360, 2385, 9886, 0, 1}, {360, 2384, 9886, 0, 1}, {360, 2383, 9886, 0, 1},
      /**
      ...
      {-1, 2715, 3466, 0, 0}, {-1, 2712, 3466, 0, 0}, {-1, 2713, 3464, 0, 0},
      {-1, 2711, 3467, 0, 0}, {-1, 2710, 3465, 0, 0}, {-1, 2709, 3464, 0, 0},
      {-1, 2708, 3466, 0, 0}, {-1, 2707, 3467, 0, 0}, {-1, 2704, 3465, 0, 0},
      {-1, 2714, 3466, 0, 0}, {-1, 2705, 3457, 0, 0}, {-1, 2709, 3461, 0, 0},
      {-1, 2709, 3459, 0, 0}, {-1, 2708, 3458, 0, 0}, {-1, 2710, 3457, 0, 0},
      {-1, 2711, 3461, 0, 0}, {-1, 2713, 3461, 0, 0}, {-1, 2712, 3459, 0, 0},
      {-1, 2712, 3457, 0, 0}, {-1, 2714, 3458, 0, 0}, {-1, 2705, 3459, 0, 0},
      {-1, 2705, 3464, 0, 0}, {2274, 2912, 5300, 2, 0}, {2274, 2914, 5300, 1, 0},
      ...
      {1661, 3124, 9664, 0, 3}, {4483, 2918, 2885, 0, 3}, {1746, 3090, 3492, 0, 1},
      {2644, 2737, 3444, 0, 0},
      // Fishing @ Donator Zone
      {10091, 2560, 3892, 0, 0}, {-1, 2608, 4777, 0, 0}, {-1, 2601, 4774, 0, 0},
      {-1, 2611, 4776, 0, 0},
      /** New Member Zone */
      ...
      /** New Member Zone end */
      {-1, 3098, 3496, 0, 1}, {-1, 3095, 3498, 0, 1}, {-1, 3088, 3509, 0, 1},
      {-1, 3095, 3499, 0, 1}, {-1, 3085, 3506, 0, 1}, {30205, 3085, 3509, 0, 3},
      {-1, 3206, 3263, 0, 0}, {-1, 2794, 2773, 0, 0}, {2, 2692, 3712, 0, 3}, {2, 2688, 3712, 0, 1},
      {4483, 3081, 3496, 0, 1}, {4483, 3081, 3495, 0, 1}, {409, 3087, 3483, 0, 0},
      {409, 2501, 3865, 0, 0}, {411, 3085, 3483, 0, 0}, {6552, 3092, 3487, 0, 2},
      {410, 3079, 3484, 0, 2}, {4874, 3097, 3500, 0, 0}, {4875, 3098, 3500, 0, 0},
      {4876, 3096, 3500, 0, 0}, {4877, 3095, 3500, 0, 0}, {4878, 3094, 3500, 0, 0},
      {12356, 3080, 3497, 0, 0}, {2182, 3078, 3497, 0, 0}, {11758, 3019, 9740, 0, 0},
      ...
      {50547, 3445, 3717, 0, 3}, {2465, 3085, 3512, 0, 0}, {-1, 3090, 3496, 0, 0},
      {-1, 3090, 3494, 0, 0}, {-1, 3092, 3496, 0, 0}, {-1, 3659, 3508, 0, 0},
      {4053, 3660, 3508, 0, 0}, {4051, 3659, 3508, 0, 0}, {1, 3649, 3506, 0, 0},
      {1, 3650, 3506, 0, 0}, {1, 3651, 3506, 0, 0}, {1, 3652, 3506, 0, 0}, {8702, 3423, 2911, 0, 0},
      {11356, 3418, 2917, 0, 1}, {-1, 2860, 9734, 0, 1}, {-1, 2857, 9736, 0, 1},
