...
public class WildernessObelisks {
  ...
  public static boolean handleObelisk(int objectId) {
    ...
    if (index >= 0) {
      if (!OBELISK_ACTIVATED[index]) {
        ...
        obelisks[0] =
            new GameObject(14825, new Position(OBELISK_COORDS[index][0], OBELISK_COORDS[index][1]));
    ...
    for (Player player : World.getPlayers()) {
      ...
      if (player.getTeleblockTimer() > 0) {
        player.getPacketSender()
            .sendMessage("You cannot use this obelisk while you are teleblocked.");
        return;
      }
  ...
  private static final int[][] OBELISK_COORDS =
      {{3154, 3618}, {3225, 3665}, {3033, 3730}, {3104, 3792}, {2978, 3864}, {3305, 3914}};
