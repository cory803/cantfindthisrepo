...
public class Runecrafting {
  ...
  public static void craftRunes(final Player player, RunecraftingData.RuneData rune) {
    ...
    player.getPacketSender()
        .sendMessage("You bind the altar's power into " + rune.getName() + "s..");
  ...
  public static boolean canRuneCraft(Player player, RunecraftingData.RuneData rune) {
    ...
    if (rune.pureRequired() && !player.getInventory().contains(7936)
      ...
      return false;
        ...
        && player.getInventory().contains(1436)) {
      player.getPacketSender()
          .sendMessage("Only Pure essence has the power to bind this altar's energy.");
      return false;
    }
    if (!player.getInventory().contains(7936) && !player.getInventory().contains(1436)) {
      player.getPacketSender()
          .sendMessage("You do not have any Rune or Pure essence in your inventory.");
      return false;
    }
