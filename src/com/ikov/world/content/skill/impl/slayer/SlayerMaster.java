...
public enum SlayerMaster {
  ...
  VANNAKA(1, 1597, new Position(3145, 9912)), DURADEL(50, 8275, new Position(2826, 2958)), KURADEL(
      80, 9085, new Position(1748, 5326)), SUMONA(92, 7780,
          new Position(3068, 3518)), NASTROTH(80, 5532, new Position(9999, 9999));
  ...
  public static void changeSlayerMaster(Player player, SlayerMaster master) {
    ...
    if (player.getSkillManager().getCurrentLevel(Skill.SLAYER) < master.getSlayerReq()) {
      player.getPacketSender().sendMessage(
          "This Slayer master does not teach noobies. You need a Slayer level of at least "
              + master.getSlayerReq() + ".");
      return;
    }
    ...
    if (player.getSlayer().getSlayerMaster() == master) {
      player.getPacketSender().sendMessage("" + Misc.formatText(master.toString().toLowerCase())
          + " is already your Slayer master.");
      return;
    }
