...
public class ConstructionDialogues {
  ...
  public static Dialogue mainPortalDialogue() {
    return new Dialogue() {
      ...
      public String[] dialogue() {
        return new String[] {"Enter your house", "Enter your house (building mode)",
  ...
  public static Dialogue hireServantDeclineDialogue(final Player p, final int npc,
      final String errorReq) {
    return new Dialogue() {
      @Override
      public DialogueType type() {
        return DialogueType.NPC_STATEMENT;
  ...
  public static Dialogue servantOptions(final Player p, final int type) {
    return new Dialogue() {
      ...
      public String[] dialogue() {
        if (type == 455) {
          return new String[] {"Bolt of cloth", "Gold leaf", "Marble block", "Magic stone",
              "Previous"};
        } else if (type == 454) {
          ...
          final Servant servant =
              (p.getRegionInstance() instanceof House ? (House) p.getRegionInstance()
  ...
  public static Dialogue buildTrapdoor(final Player p) {
    return new Dialogue() {
      ...
      @Override
      public String[] dialogue() {
        return new String[] {"This trapdoor lead nowhere.",
            "Would you like to build an oubliette under this room?"};
      }
