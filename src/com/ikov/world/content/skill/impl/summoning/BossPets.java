...
public class BossPets {
	...
	public static enum BossPet {
		...
		PET_LIME_ROCK_CRAB(5507, 5551, 13001),
		PET_AQUA_ROCK_CRAB(5508, 5552, 13002),
		PET_PINK_ROCK_CRAB(5509, 5553, 13003),
		PET_RED_ROCK_CRAB(5510, 5554, 13004),
		PET_WHITE_ROCK_CRAB(5511, 5555, 13005),
