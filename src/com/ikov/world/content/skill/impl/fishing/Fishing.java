package com.ikov.world.content.skill.impl.fishing;
...
public class Fishing {
  ...
  public enum Spot {
    ...
    LURE(318, new int[] {335, 331}, 309, 314, new int[] {20, 30}, true, new int[] {1550, 2120},
        623),

    CAGE(312, new int[] {377}, 301, -1, new int[] {40}, false, new int[] {2980}, 619),

    BIGNET(313, new int[] {353, 341, 363}, 305, -1, new int[] {16, 23, 46}, false,
        new int[] {780, 1130, 2120}, 621),

    SMALLNET(316, new int[] {317, 321}, 303, -1, new int[] {1, 15}, false, new int[] {290, 550},
        621),

    MONK_FISH(318, new int[] {7944, 3142, 389}, 305, -1, new int[] {62, 65, 81}, false,
        new int[] {6985, 7435, 10122}, 621),

    HARPOON(312, new int[] {359, 371}, 311, -1, new int[] {35, 50}, true, new int[] {2530, 5100},
        618),
    ...
    private Spot(int npcId, int[] rawFish, int equipment, int bait, int[] fishingReqs,
        boolean second, int[] xp, int anim) {
      this.npcId = npcId;
  ...
  public static void setupFishing(Player p, Spot s) {
    ...
    if (p.getSkillManager().getCurrentLevel(Skill.FISHING) >= s.getLevelReq()[0]) {
      if (p.getInventory().contains(s.getEquipment()) || Skillcape_Data.STRENGTH.isWearingCape(p) || Skillcape_Data.MASTER_STRENGTH.isWearingCape(p)) {
        if (s.getBait() != -1) {
