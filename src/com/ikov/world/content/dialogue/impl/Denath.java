	...
	public static Dialogue getDialogue(Player player) {
		return new Dialogue() {
			...
			public String[] dialogue() {
				return new String[]{"@bla@Come back when you have all "+player.getMinigameAttributes().getClawQuestAttributes().SAMPLES_NEEDED+" of my", "samples. I will make it into something for you."};
			}
