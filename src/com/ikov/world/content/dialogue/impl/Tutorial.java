    ...
    switch (stage) {
        ...
        dialogue = new Dialogue() {
          ...
          public String[] dialogue() {
            return new String[] {"You can earn money doing many different things in",
                "Ikov. For example, see those Thieving stalls infront of ",
        ...
        dialogue = new Dialogue() {
          ...
          public String[] dialogue() {
            return new String[] {"Enough of the boring stuff, let's show you some creatures!",
                "There are a bunch of bosses to fight in Ikov.",
      ...
      case 8:
        dialogue = new Dialogue() {
          ...
          @Override
          public String[] dialogue() {
            return new String[] {"Ikov also has a lot of enjoyable minigames.",
      ...
      case 11:
        dialogue = new Dialogue() {
          ...
          @Override
          public String[] dialogue() {
            return new String[] {"Ikov is a competitive game. Next to you is a scoreboard",
        ...
        dialogue = new Dialogue() {
          ...
          public String[] dialogue() {
            return new String[] {"If you have any more questions, simply use the ::help",
                ...
                "other players for help there too. Have fun playing Ikov!"};
          };
