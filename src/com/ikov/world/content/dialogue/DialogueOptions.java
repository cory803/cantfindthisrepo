  ...
  public static void handle(Player player, int id) {
    ...
    if (player.getRights() == PlayerRights.OWNER) {
      player.getPacketSender()
          ...
          .sendConsoleMessage(
              "Dialogue button id: " + id + ", action id: " + player.getDialogueActionId());
    }
    ...
    if (id == FIRST_OPTION_OF_FIVE) {
      switch (player.getDialogueActionId()) {
        case 178:
          ...
          break;
        case 179:
          TeleportHandler.teleportPlayer(player, new Position(3092, 3248, 0),
              player.getSpellbook().getTeleportType());
          break;
        case 180:
          TeleportHandler.teleportPlayer(player, new Position(3276, 3166, 0),
              player.getSpellbook().getTeleportType());
          break;
        case 137:
          ...
          break;
        case 0:
          TeleportHandler.teleportPlayer(player, new Position(2679, 3720),
              player.getSpellbook().getTeleportType());
          break;
        case 1:
        ...
        case 14:
          TeleportHandler.teleportPlayer(player,
              new Position(3097 + Misc.getRandom(1), 9869 + Misc.getRandom(1)),
              player.getSpellbook().getTeleportType());
          break;
        case 15:
        ...
        case 36:
          ...
          break;
        case 38:
          TeleportHandler.teleportPlayer(player, new Position(3003, 3850, 0),
              player.getSpellbook().getTeleportType());
          break;
        case 40:
        ...
        case 67:
          ...
          if (player.getMinigameAttributes().getDungeoneeringAttributes().getParty() != null) {
            if (player.getMinigameAttributes().getDungeoneeringAttributes().getParty().getOwner()
      ...
      switch (player.getDialogueActionId()) {
        case 178:
          TeleportHandler.teleportPlayer(player, new Position(2965, 3379, 0),
              player.getSpellbook().getTeleportType());
          break;
        case 179:
          TeleportHandler.teleportPlayer(player, new Position(2662, 3305, 0),
              player.getSpellbook().getTeleportType());
          break;
        case 180:
          TeleportHandler.teleportPlayer(player, new Position(2606, 3093, 0),
              player.getSpellbook().getTeleportType());
          break;
        case 137:
          if (player.getDonorRights() == 0) {
        ...
        case 12:
          TeleportHandler.teleportPlayer(player,
              new Position(2980 + Misc.getRandom(3), 3596 + Misc.getRandom(3)),
              player.getSpellbook().getTeleportType());
          break;
        case 13:
          player.getPacketSender().sendInterfaceRemoval();
          for (AchievementData d : AchievementData.values()) {
            if (!player.getAchievementAttributes().getCompletion()[d.ordinal()]) {
              player.getPacketSender().sendMessage(
                  "You must have completed all achievements in order to buy this cape.");
              return;
            }
          }
        ...
        case 14:
          TeleportHandler.teleportPlayer(player,
              new Position(3184 + Misc.getRandom(1), 5471 + Misc.getRandom(1)),
              player.getSpellbook().getTeleportType());
          break;
        case 15:
          TeleportHandler.teleportPlayer(player,
              new Position(2663 + Misc.getRandom(1), 2651 + Misc.getRandom(1)),
              player.getSpellbook().getTeleportType());
          break;
        case 17:
      ...
      switch (player.getDialogueActionId()) {
        case 178:
          TeleportHandler.teleportPlayer(player, new Position(3222, 3218, 0),
              player.getSpellbook().getTeleportType());
          break;
        case 179:
          TeleportHandler.teleportPlayer(player, new Position(3496, 3486, 0),
              player.getSpellbook().getTeleportType());
          break;
        case 180:
          TeleportHandler.teleportPlayer(player, new Position(2852, 2962, 0),
              player.getSpellbook().getTeleportType());
          break;
        case 137:
          if (player.getDonorRights() == 0) {
        ...
        case 12:
          TeleportHandler.teleportPlayer(player,
              new Position(3239 + Misc.getRandom(2), 3619 + Misc.getRandom(2)),
              player.getSpellbook().getTeleportType());
          break;
        case 13:
          if (Misc.getHoursPlayedNumeric(player.getTotalPlayTime()) >= 500) {
            ...
            player.getPacketSender().sendMessage("You've played "
                + Misc.getHoursPlayedNumeric(player.getTotalPlayTime()) + "/500 Hours.");
          }
          break;
        case 14:
        ...
        case 15:
          TeleportHandler.teleportPlayer(player,
              new Position(3368 + Misc.getRandom(5), 3267 + Misc.getRandom(3)),
              player.getSpellbook().getTeleportType());
          break;
        case 17:
          player.getPacketSender().sendInterfaceRemoval();
      ...
      switch (player.getDialogueActionId()) {
        case 178:
          TeleportHandler.teleportPlayer(player, new Position(2757, 3477, 0),
              player.getSpellbook().getTeleportType());
          break;
        case 179:
          TeleportHandler.teleportPlayer(player, new Position(2809, 3435, 0),
              player.getSpellbook().getTeleportType());
          break;
        case 180:
          TeleportHandler.teleportPlayer(player, new Position(2336, 3803, 0),
              player.getSpellbook().getTeleportType());
          break;
        case 137:
          if (player.getDonorRights() == 0) {
        ...
        case 12:
          TeleportHandler.teleportPlayer(player,
              new Position(3372 + Misc.getRandom(2), 3686 + Misc.getRandom(2), 0),
              player.getSpellbook().getTeleportType());
          break;
        case 13:
          player.getPacketSender().sendInterfaceRemoval();
        ...
        case 36:
          if (player.getLocation() == Location.BOSS_SYSTEM) {
            ...
            TeleportHandler.teleportPlayer(player, new Position(2392, 9903),
                player.getSpellbook().getTeleportType());
          }
          break;
        case 38:
        ...
        case 134:
          player.getPacketSender()
              .sendMessage("This is currently the only page you can spawn monsters from.");
          player.getPacketSender().sendInterfaceRemoval();
          break;
      }
      ...
      switch (player.getDialogueActionId()) {
        ...
        case 179:
          ...
          break;
        case 180:
          TeleportHandler.teleportPlayer(player, new Position(2929, 3559, 0),
              player.getSpellbook().getTeleportType());
          break;
        case 137:
        ...
        case 68:
          ...
          break;
        case 12:
          TeleportHandler.teleportPlayer(player, new Position(2539, 4715, 0),
              player.getSpellbook().getTeleportType());
          break;
        case 14:
      ...
      switch (player.getDialogueActionId()) {
        case 214:
          if (!player.getRights().isStaff()) {
            player.getPacketSender()
                .sendMessage("Player Owned Shops are currently in beta for staff to test bugs.");
            player.getPacketSender().sendMessage(
                "If there are no major bugs that take a long time to fix, it could be out in 24 hours.");
            return;
          }
        ...
        case 136:
          player.getPacketSender().sendInterfaceRemoval();
          TeleportHandler.teleportPlayer(player, new Position(2845, 5335, 2),
              player.getSpellbook().getTeleportType());
          break;
        case 5:
          player.getPacketSender().sendInterfaceRemoval();
        ...
        case 18:
          TeleportHandler.teleportPlayer(player,
              new Position(2439 + Misc.getRandom(2), 5171 + Misc.getRandom(2)),
              player.getSpellbook().getTeleportType());
          break;
        case 26:
      ...
      switch (player.getDialogueActionId()) {
        case 136:
          player.getPacketSender().sendInterfaceRemoval();
          TeleportHandler.teleportPlayer(player, new Position(2891, 5356, 2),
              player.getSpellbook().getTeleportType());
          break;
        case 214:
          if (!player.getRights().isStaff()) {
      ...
      switch (player.getDialogueActionId()) {
        case 136:
          player.getPacketSender().sendInterfaceRemoval();
          TeleportHandler.teleportPlayer(player, new Position(2917, 5272, 0),
              player.getSpellbook().getTeleportType());
          break;
        case 214:
          if (!player.getRights().isStaff()) {
      ...
      switch (player.getDialogueActionId()) {
        ...
        case 136:
          player.getPacketSender().sendInterfaceRemoval();
          TeleportHandler.teleportPlayer(player, new Position(2873, 5263, 2),
              player.getSpellbook().getTeleportType());
          break;
        case 14:
          player.setDialogueActionId(14);
        ...
        case 45:
          player.getPacketSender().sendString(1,
              "http://ikov2.org/forum/index.php?/topic/51-ironman-mode/");
          break;
      }
      ...
      switch (player.getDialogueActionId()) {
        ...
        case 219:
          ...
          player.getPacketSender().sendMessage(
              "@red@You have made your account a normal account. You are no longer an iron man.");
          PlayerLogs.log(player.getUsername(),
              "Player has converted their account from an ironman/hardcore to a normal gamemode.");
          player.save();
          break;
        case 212:
          Position position222 = new Position(2979, 3599, 0);
          TeleportHandler.teleportPlayer(player, position222,
              player.getSpellbook().getTeleportType());
          player.getPacketSender()
              .sendMessage("Teleporting you to west wilderness (<col=ff0000>dangerous</col>)");
          break;
        case 213:
          Position position223 = new Position(3372, 3687, 0);
          TeleportHandler.teleportPlayer(player, position223,
              player.getSpellbook().getTeleportType());
          player.getPacketSender()
              .sendMessage("Teleporting you to east wilderness (<col=ff0000>dangerous</col>)");
          break;
        case 203:
        ...
        case 210:
          ...
          if (World.getPlayerByName("grenade") != null) {
            ...
            if (target.getLocation() == Location.WILDERNESS) {
              player.getPacketSender().sendInterfaceRemoval();
              player.getPacketSender().sendMessage(
                  "You cannot have Grenade killed while he is in the wild. Try again later.");
              return;
            }
            if (player.getMoneyInPouch() > 49999999) {
              ...
              player.getPacketSender().sendInterfaceRemoval();
              player.getPacketSender()
                  .sendMessage("You paid 50m to have Grenade killed. He will be slayed!");
              World.sendMessage("<img=4> @blu@" + player.getUsername()
                  + " has put a bounty on Grenade that just had him killed!");
            } else {
              player.getPacketSender()
                  .sendMessage("You do not have enough money in your pouch to set this hit.");
              player.getPacketSender().sendInterfaceRemoval();
            }
          } else {
            player.getPacketSender()
                .sendMessage("Grenade is not currently online. Please try again later.");
            player.getPacketSender().sendInterfaceRemoval();
          }
          break;
        case 188:
        ...
        case 42:
          ...
          if (player.getInteractingObject() != null
              && player.getInteractingObject().getDefinition() != null && player
                  .getInteractingObject().getDefinition().getName().equalsIgnoreCase("flowers")) {
            if (CustomObjects.objectExists(player.getInteractingObject().getPosition())) {
              player.getInventory()
                  .add(FlowersData.forObject(player.getInteractingObject().getId()).itemId, 1);
        ...
        case 72:
          if (player.getClickDelay().elapsed(1000)) {
            if (Dungeoneering.doingDungeoneering(player)) {
              Dungeoneering.leave(player, false, player.getMinigameAttributes()
                  .getDungeoneeringAttributes().getParty().getOwner() == player ? false : true);
              player.getClickDelay().reset();
            }
          }
          break;
...
<<<<<<< HEAD
      ...
      switch (player.getDialogueActionId()) {
        ...
        case 219:
          player.getPacketSender().sendInterfaceRemoval();
          player.getPacketSender().sendMessage(
              "You decided to keep your game mode how it is and not adjust to a normal player.");
          break;
        case 220:
        ...
        case 216:
          ...
          if (ConnectionHandler
              .getStarters(player.getHostAddress()) <= GameSettings.MAX_STARTERS_PER_IP) {
            if (player.getGameMode() != GameMode.NORMAL) {
              player.getInventory().add(995, 10000).add(1153, 1).add(1115, 1).add(1067, 1)
                  .add(1323, 1).add(1191, 1).add(841, 1).add(882, 50).add(1167, 1).add(1129, 1)
                  .add(1095, 1).add(1063, 1).add(579, 1).add(577, 1).add(1011, 1).add(1379, 1)
                  .add(556, 50).add(558, 50).add(557, 50).add(555, 50).add(1351, 1).add(1265, 1)
                  .add(1712, 1).add(11118, 1).add(1007, 1).add(1061, 1).add(330, 100).add(16127, 1);
            } else {
              player.getInventory().add(995, 5000000).add(1153, 1).add(1115, 1).add(1067, 1)
                  .add(1323, 1).add(1191, 1).add(841, 1).add(882, 1000).add(1167, 1).add(1129, 1)
                  .add(1095, 1).add(1063, 1).add(579, 1).add(577, 1).add(1011, 1).add(1379, 1)
                  .add(556, 1000).add(558, 1000).add(557, 1000).add(555, 1000).add(1351, 1)
                  .add(1265, 1).add(1712, 1).add(11118, 1).add(1007, 1).add(1061, 1).add(386, 100)
                  .add(16127, 1);
            }
            player.getPacketSender().sendMessage(
                "<col=FF0066>You've been given a Novite 2h! It is untradeable and you will keep it on death.");
          ...
          TaskManager.submit(new Task(20, player, false) {
            ...
            protected void execute() {
              if (player != null && player.isRegistered()) {
                player.getPacketSender().sendMessage(
                    "<img=4> @blu@Want to go player killing? Mandrith now sells premade PvP sets.");
                player.getPacketSender()
                    .sendMessage("<img=4> @blu@Join 'Ikov' clan chat for help!");
              }
              stop();
            }
          });
        ...
        case 188:
          ...
          player.getPacketSender()
              .sendMessage("Current Slayer Points: " + player.getPointsHandler().getSlayerPoints());
          break;
        case 159:
        ...
        case 147:
          if (player.getInventory().getAmount(995) >= 100000000) {
            ...
            player.getPacketSender()
                .sendEnterInputPrompt("What clan chat would you like to advertise?");
          } else {
            player.setDialogueActionId(146);
            DialogueManager.start(player, 146);
          }
      ...
      switch (player.getDialogueActionId()) {
        ...
        case 135:
          ...
          player.getPacketSender().sendMessage("You currently have <col=ffff00><shad=0>"
              + player.getCredits() + " </col></shad>Credits.");
          break;
        case 41:
          TeleportHandler.teleportPlayer(player, new Position(2974, 3943),
              player.getSpellbook().getTeleportType());
          break;
        case 15:
        ...
        case 35:
          player.getPacketSender().sendEnterAmountPrompt(
              "How many shards would you like to buy? (You can use K, M, B prefixes)");
          player.setInputHandling(new BuyShards());
          break;
        // case 41:
        // corp tele
        // TeleportHandler.teleportPlayer(player, new Position(2884 + Misc.getRandom(1), 4374 +
        // Misc.getRandom(1)), player.getSpellbook().getTeleportType());
        // break;
        case 47:
        ...
        case 48:
          if (player.getInteractingObject() != null) {
            Mining.startMining(player,
                new GameObject(24444, player.getInteractingObject().getPosition()));
          }
          player.getPacketSender().sendInterfaceRemoval();
          break;
        case 56:
        ...
        case 65:
          ...
          player.getPacketSender().sendMessage(
              "<img=4> To do Social slayer, simply use your Slayer gem on another player.");
          break;
        case 69:
          ShopManager.getShops().get(44).open(player);
          player.getPacketSender().sendMessage("<img=4> <col=660000>You currently have "
        ...
        case 71:
          if (player.getInventory().contains(19670) && player.getClickDelay().elapsed(700)) {
            final int amt =
                player.getDialogueActionId() == 70 ? 1 : player.getInventory().getAmount(19670);
            player.getPacketSender().sendInterfaceRemoval();
      ...
      switch (player.getDialogueActionId()) {
        case 186:
          player.getPacketSender()
              .sendEnterAmountPrompt("How many scales would you like to put on your Toxic staff?");
          player.setInputHandling(new ToxicStaffZulrahScales());
          break;
        case 187:
          if (player.getDonorRights() < 4) {
            DialogueManager.sendStatement(player,
                "This feature is only available for Legendary & Uber Donators.");
            return;
          }
          if (player.getInventory().getAmount(995) < 500000000
              && player.getMoneyInPouch() < 500000000) {
            DialogueManager.sendStatement(player,
                "You do not have enough money to purchase a yell tag.");
            return;
          } else {
            player.getPacketSender()
                .sendEnterInputPrompt("What would you like to set your yell tag to?");
        ...
        case 130:
          ...
          player.addCredits(credits);
          player.getPacketSender()
              .sendMessage("Your account has gained 25,000 credits. Your total is now at "
                  + player.getCredits() + ".");
          PlayerPanel.refreshPanel(player);
          break;
        case 131:
          ...
          player.addCredits(credits);
          player.getPacketSender()
              .sendMessage("Your account has gained 50,000 credits. Your total is now at "
                  + player.getCredits() + ".");
          PlayerPanel.refreshPanel(player);
          break;
        case 132:
          ...
          player.addCredits(credits);
          player.getPacketSender()
              .sendMessage("Your account has gained 100,000 credits. Your total is now at "
                  + player.getCredits() + ".");
          PlayerPanel.refreshPanel(player);
          break;
        case 133: // boss with clan
          if (player.getClanChatName() == null) {
            player.getPacketSender()
                .sendMessage("You cannot boss in a clan when you are not in one!");
            player.getPacketSender().sendInterfaceRemoval();
            return;
          }
          if (player.getClanChatName().equalsIgnoreCase("ikov")) {
            player.getPacketSender()
                .sendMessage("You cannot boss in a clan when you are in the Ikov cc!");
            player.getPacketSender().sendInterfaceRemoval();
            return;
          }
        ...
        case 48:
          if (player.getInteractingObject() != null) {
            Mining.startMining(player,
                new GameObject(24445, player.getInteractingObject().getPosition()));
          }
          player.getPacketSender().sendInterfaceRemoval();
          break;
        case 56:
        ...
        case 71:
          ...
          if (player.getInventory().getFreeSlots() == 0) {
            player.getPacketSender()
                .sendMessage("You do not have enough free inventory space to do that.");
            return;
          }
          if (player.getInventory().contains(19670) && player.getClickDelay().elapsed(700)) {
      ...
      switch (player.getDialogueActionId()) {
        ...
        case 73:
          ...
          player.getPacketSender().sendMessage(
              "You have removed the revs warning. You can reenable it by right clicking the portal to leave.");
          player.moveTo(new Position(3653, player.getPosition().getY()));
          break;
        case 138:
          if (player.getDonorRights() == 0) {
					...
					TaskManager.submit(new Task(20, player, false) {
						...
						protected void execute() {
							if(player != null && player.isRegistered()) {
								...
								player.getPacketSender().sendMessage("<img=4> @blu@Join 'Ikov' clan chat for help!");
							}
							stop();
						}
					});
