...
public enum PkSets {
	...
	HYBRIDING_MAIN_SET(2300000, new Item[] {new Item(10828), new Item(1704), new Item(4091), new Item(4093), new Item(2503), new Item(2497), new Item(3105), new Item(4675), new Item(13734), new Item(1725), new Item(1127), new Item(1163), new Item(4587), new Item(1215), new Item(1187), new Item(6568), new Item(555, 600), new Item(560, 400), new Item(565, 200), new Item(386, 100), new Item(6686, 15), new Item(3025, 25), new Item(3041, 15), new Item(2441, 15), new Item(2437, 15), new Item(2443, 15)}),
	
	RANGE_MAIN_SET(1500000, new Item[]{new Item(10828), new Item(1704), new Item(10499), new Item(4131), new Item(1079), new Item(2503), new Item(9185), new Item(2491), new Item(9185), new Item(9244, 50), new Item(861), new Item(892, 100), new Item(13734), new Item(560, 100), new Item(9075, 200), new Item(557, 500), new Item(386, 100), new Item(2445, 15), new Item(3025, 15), new Item(2443, 15)}),
	
	MELEE_MAIN_SET(1300000, new Item[]{new Item(10828), new Item(1725), new Item(2550), new Item(1127), new Item(1079), new Item(4131), new Item(4587), new Item(1215), new Item(1187), new Item(6568), new Item(560, 100), new Item(9075, 200), new Item(557, 500), new Item(386, 100), new Item(2441, 15), new Item(2437, 15), new Item(2443, 15), new Item(3025, 25)}),
	
	MAGIC_MAIN_SET(1600000, new Item[]{new Item(3755), new Item(1704), new Item(4091), new Item(4093), new Item(4097), new Item(4675), new Item(2550), new Item(13734), new Item(555, 600), new Item(560, 400), new Item(565, 200), new Item(386, 100), new Item(3041, 15), new Item(3025, 25)});
