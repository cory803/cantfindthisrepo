...
public class GrandExchangeOffer extends Item {
  ...
  public GrandExchangeOffer(int item, int quantity, String owner, int index, int pricePerItem,
      int box, OfferType type) {
    super(item, quantity);
    this.owner = owner;
    this.index = index;
  ...
  public GrandExchangeOffer(int item, int quantity, String owner, int index, int pricePerItem,
      int box, int amountFinished, int coinsCollect, int itemCollect, int failedAttempts,
      OfferType type, int updateStateOrdinal) {
    super(item, quantity);
    this.owner = owner;
    this.index = index;
    this.pricePerItem = pricePerItem;
