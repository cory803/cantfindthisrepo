...
public class ItemDegrading {
  ...
  public static boolean handleItemDegrading(Player p, DegradingItem d) {
    ...
    if (equipId == d.nonDeg || equipId == d.deg) {
      ...
      p.getEquipment().setItem(d.equipSlot, new Item(degradeCompletely ? -1 : d.deg))
          .refreshItems();
      ...
      p.getPacketSender().sendMessage("Your "
          + ItemDefinition.forId(equipId).getName().replace(" (deg)", "") + " has " + ext + "!");
      return true;
    } else {
      return false;
    }
  ...
  public enum DegradingItem {
    ...
    CORRUPT_VESTAS_CHAINBODY(13911, 13913, Equipment.BODY_SLOT, 200), CORRUPT_VESTAS_PLATESKIRT(
        13917, 13919, Equipment.LEG_SLOT, 200), CORRUPT_VESTAS_LONGSWORD(13923, 13925,
            ...
            160), CORRUPT_VESTAS_SPEAR(13929, 13931, Equipment.WEAPON_SLOT, 160),
     ...
     * Brawling gloves
     */
    BRAWLING_GLOVES_SMITHING(13855, 13855, Equipment.HANDS_SLOT, 600), BRAWLING_GLOVES_PRAYER(13848,
        13848, Equipment.HANDS_SLOT, 600), BRAWLING_GLOVES_COOKING(13857, 13857,
            Equipment.HANDS_SLOT, 600), BRAWLING_GLOVES_FISHING(13856, 13856, Equipment.HANDS_SLOT,
                600), BRAWLING_GLOVES_THIEVING(13854, 13854, Equipment.HANDS_SLOT,
                    600), BRAWLING_GLOVES_HUNTER(13853, 13853, Equipment.HANDS_SLOT,
                        600), BRAWLING_GLOVES_MINING(13852, 13852, Equipment.HANDS_SLOT,
                            600), BRAWLING_GLOVES_FIREMAKING(13851, 13851, Equipment.HANDS_SLOT,
                                600), BRAWLING_GLOVES_WOODCUTTING(13850, 13850,
                                    Equipment.HANDS_SLOT, 600);
