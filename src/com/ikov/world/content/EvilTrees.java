...
public class EvilTrees {
  ...
  public static enum LocationData {
    ...
    LOCATION_1(new Position(3107, 3506), "To the right of the Edgeville bank",
        "Edgeville"), LOCATION_2(new Position(3087, 3541), "at the Wilderness ditch, level 3",
            "Wilderness"), LOCATION_3(new Position(2470, 5166), "@ the Enterence of TzHaar dungeon",
                "TzHaar"), LOCATION_4(new Position(3362, 3285), "behind the Duel Arena",
                    "Duel Arena"), LOCATION_5(new Position(2928, 3453),
                        "at the enterence of Taverley", "Taverley"),;
  ...
  public static void sequence() {
    if (SPAWNED_TREE == null) {
      if (timer.elapsed(TIME)) {
        ...
        World.sendMessage(
            "<img=4> <shad=1><col=FF9933>The evil tree has grown " + locationData.clue + "!");
        World.getPlayers()
            .forEach(p -> p.getPacketSender().sendString(39163, "@or2@Evil Tree: @yel@"
