...
import com.ikov.world.content.combat.instanced.InstancedCerberus;
...
public class Locations {
  ...
  public enum Location {
    DUNGEONEERING(new int[] {3433, 3459, 2421, 2499}, new int[] {3694, 3729, 4915, 4990}, true,
        false, true, false, true, false) {
      @Override
      public void login(Player player) {
        player.getPacketSender().sendDungeoneeringTabIcon(true)
            .sendTabInterface(GameSettings.QUESTS_TAB, 27224).sendTab(GameSettings.QUESTS_TAB);
      }
    ...
    MEMBER_ZONE(new int[] {3415, 3435}, new int[] {2900, 2926}, false, true, true, false, false,
        true) {},
    ...
    BANK(
        new int[] {3090, 3099, 3089, 3090, 3248, 3258, 3179, 3191, 2944, 2948, 2942, 2948, 2944,
            2950, 3008, 3019, 3017, 3022, 3203, 3213, 3212, 3215, 3215, 3220, 3220, 3227, 3227,
            3230, 3226, 3228, 3227, 3229},
        new int[] {3487, 3500, 3492, 3498, 3413, 3428, 3432, 3448, 3365, 3374, 3367, 3374, 3365,
            3370, 3352, 3359, 3352, 3357, 3200, 3237, 3200, 3235, 3202, 3235, 3202, 3229, 3208,
            3226, 3230, 3211, 3208, 3226},
        false, true, true, false, false, true) {},
    EDGEVILLE(new int[] {3073, 3134}, new int[] {3457, 3518}, false, true, true, false, false,
        true) {},
    LUMBRIDGE(new int[] {3175, 3238}, new int[] {3179, 3302}, false, true, true, true, true,
        true) {},
    DONATOR_ZONE(new int[] {2489, 2636}, new int[] {3827, 3933}, false, true, true, true, true,
        true) {
      @Override
      public void process(Player player) {
    ...
    BANDOS_AVATAR(new int[] {2877, 2928}, new int[] {4734, 4787}, true, true, true, true, true,
        true) {},
    KALPHITE_QUEEN(new int[] {3464, 3500}, new int[] {9478, 9523}, true, true, true, true, true,
        true) {},
    PHOENIX(new int[] {2824, 2862}, new int[] {9545, 9594}, true, true, true, true, true, true) {},
    // BANDIT_CAMP(new int[]{3020, 3150, 3055, 3195}, new int[]{3684, 3711, 2958, 3003}, true, true,
    // true, true, true, true) {
    // },
    ROCK_CRABS(new int[] {2663, 2729}, new int[] {3691, 3730}, true, true, true, true, true,
        true) {},
    ARMOURED_ZOMBIES(new int[] {3077, 3132}, new int[] {9657, 9680}, true, true, true, true, true,
        true) {},
    CORPOREAL_BEAST(new int[] {2879, 2962}, new int[] {4368, 4406}, true, true, true, false, true,
        true) {},
    ...
    JAIL(new int[] {1967, 1982}, new int[] {4997, 5013}, false, false, false, false, false, false) {
      ...
      public void process(Player player) {
        if (player.isJailed() && player.getLocation() != Location.JAIL) {
          player.getPacketSender()
              .sendMessage("What are you doing out of your cell? Get back in there!");
        }
      }
      ...
      public boolean canTeleport(Player player) {
        if (player.isJailed()) {
          player.getPacketSender()
              .sendMessage("You cannot teleport out of jail... What're you thinking?");
          return false;
        }
        return true;
      }
    ...
    WILDKEY_ZONE(new int[] {3352, 3390}, new int[] {3870, 3905}, true, true, true, false, true,
        true) {
      @Override
      public void process(Player player) {
        player.setWildernessLevel(60);
        player.getPacketSender().sendString(25352, "" + player.getWildernessLevel());
        player.getPacketSender().sendString(25355,
            "Levels: " + CombatFactory.getLevelDifference(player, false) + " - "
      ...
      public boolean canAttack(Player player, Player target) {
        int combatDifference = CombatFactory.combatLevelDifference(
            player.getSkillManager().getCombatLevel(), target.getSkillManager().getCombatLevel());
        if (combatDifference > player.getWildernessLevel()
            || combatDifference > target.getWildernessLevel()) {
          player.getPacketSender()
        ...
        if (target.getLocation() != Location.WILDKEY_ZONE) {
          player.getPacketSender().sendMessage(
              "That player cannot be attacked, because they are not in the Wilderness.");
          player.getMovementQueue().reset();
          return false;
        }
        return true;
    ...
    WILDERNESS(new int[] {2940, 3392, 2986, 3012, 3653, 3720, 3650, 3653},
      ...
      public boolean canAttack(Player player, Player target) {
        ...
        /*
         * if(Misc.getMinutesPlayed(player) < 20) { player.getPacketSender().sendMessage(
         * "You must have played for at least 20 minutes in order to attack someone."); return
         * false; } if(Misc.getMinutesPlayed(target) < 20) { player.getPacketSender().sendMessage(
         * "This player is a new player and can therefore not be attacked yet."); return false; }
         */
        return true;
      }
    },
    BARROWS(new int[] {3520, 3598, 3543, 3584, 3543, 3560},
        new int[] {9653, 9750, 3265, 3314, 9685, 9702}, false, true, true, true, true, true) {
      @Override
      public void process(Player player) {
    ...
    PEST_CONTROL_GAME(new int[] {2624, 2690}, new int[] {2550, 2619}, true, true, true, false, true,
        true) {
      @Override
      public void process(Player player) {
      ...
      public boolean canTeleport(Player player) {
        player.getPacketSender().sendMessage(
            "Teleport spells are blocked on this island. Wait for the game to finish!");
        return false;
      }
    ...
    PEST_CONTROL_BOAT(new int[] {2660, 2663}, new int[] {2638, 2643}, false, false, false, false,
        false, true) {
      @Override
      public void process(Player player) {
    ...
    SOULWARS_WAIT(new int[] {-1, -1}, new int[] {-1, -1}, false, false, false, false, false, true) {
      ...
      public boolean canTeleport(Player player) {
        player.getPacketSender()
            .sendMessage("You must leave the waiting room before being able to teleport.");
        return false;
      }
    ...
    FIGHT_CAVES(new int[] {2360, 2445}, new int[] {5045, 5125}, true, true, false, false, false,
        false) {
    ...
    ZULRAH_PIT(new int[] {2257, 2281}, new int[] {3063, 3084}, false, true, true, true, true,
            true) {
      @Override
      public void process(Player player) {}
    ...
    INSIDE_MAGE_BANK(new int[] {2525, 2555}, new int[] {4706, 4728}, true, true, true, true, true,
        true) {},
    OUTSIDE_MAGE_BANK(new int[] {3085, 3101}, new int[] {3947, 3961}, true, true, true, true, true,
        true) {},
    ...
    GRAVEYARD(new int[] {3485, 3517}, new int[] {3559, 3580}, true, true, false, true, false,
        false) {
      @Override
      public void process(Player player) {}
    ...
    FIGHT_PITS(new int[] {2370, 2425}, new int[] {5133, 5167}, true, true, true, false, false,
        true) {
      @Override
      public void process(Player player) {
      ...
      public boolean canAttack(Player player, Player target) {
        ...
        return state1 != null && state1.equals("PLAYING") && state2 != null
            && state2.equals("PLAYING");
      }
    },
    FIGHT_PITS_WAIT_ROOM(new int[] {2393, 2404}, new int[] {5168, 5176}, false, false, false, false,
        false, true) {
      @Override
      public void process(Player player) {
    ...
    DUEL_ARENA(new int[] {3322, 3394, 3311, 3323, 3331, 3391},
        new int[] {3195, 3291, 3223, 3248, 3242, 3260}, false, false, false, false, false, false) {
      @Override
      public void process(Player player) {
      ...
      public boolean canTeleport(Player player) {
        if (player.getDueling().duelingStatus == 5) {
          player.getPacketSender()
              .sendMessage("To forfiet a duel, run to the west and use the trapdoor.");
          return false;
        }
        return true;
      }
    ...
    GODWARS_DUNGEON(new int[] {2800, 2950, 2858, 2943}, new int[] {5200, 5400, 5180, 5230}, true,
      ...
      public void leave(Player p) {
        p.getMinigameAttributes().getGodwarsDungeonAttributes().setAltarDelay(0)
      ...
      public boolean handleKilledNPC(Player killer, NPC n) {
        ...
        if (npc == 6246 || npc == 6229 || npc == 6230 || npc == 6231 || npc == 6227 || npc == 6625
          ...
          index = 0;
            ...
            || npc == 6277 || npc == 6288 || npc == 6265 || npc == 6263 || npc == 6261
            || npc == 6260) // Bandos
          index = 1;
        else if (npc == 6258 || npc == 6259 || npc == 6254 || npc == 6255 || npc == 6257
            || npc == 6256 || npc == 6252 || npc == 6250 || npc == 6240 || npc == 6247) // Saradomin
          index = 2;
        else if (npc == 10216 || npc == 6216 || npc == 1220 || npc == 6007 || npc == 6219
            || npc == 6220 || npc == 6221 || npc == 49 || npc == 4418 || npc == 6208 || npc == 6206
            || npc == 6204 || npc == 6203) // Zamorak
          index = 3;
        if (index != -1) {
    ...
    RECIPE_FOR_DISASTER(new int[] {1885, 1913}, new int[] {5340, 5369}, true, true, false, false,
        false, false) {
    ...
    FREE_FOR_ALL_ARENA(new int[] {2755, 2876}, new int[] {5512, 5627}, true, true, true, false,
        false, true) {
      @Override
      public boolean canTeleport(Player player) {
        player.getPacketSender().sendMessage(
            "Teleport spells are blocked here, if you wish to teleport, use the portal.");
        return false;
      }
      ...
      public boolean canAttack(Player player, Player target) {
        if (target.getLocation() != FREE_FOR_ALL_ARENA) {
          player.getPacketSender()
              .sendMessage("That player has not entered the dangerous zone yet.");
          player.getMovementQueue().reset();
          return false;
        }
        return true;
    ...
    FREE_FOR_ALL_WAIT(new int[] {2755, 2876}, new int[] {5507, 5627}, false, false, true, false,
        false, true) {
      @Override
      public boolean canTeleport(Player player) {
        player.getPacketSender().sendMessage(
    ...
    WARRIORS_GUILD(new int[] {2833, 2879}, new int[] {3531, 3559}, false, true, true, false, false,
        true) {
      @Override
      public void logout(Player player) {
    ...
    PURO_PURO(new int[] {2556, 2630}, new int[] {4281, 4354}, false, true, true, false, false,
        true) {},
    FLESH_CRAWLERS(new int[] {2033, 2049}, new int[] {5178, 5197}, false, true, true, false, true,
        true) {},
    AGILITY_WILDERNESS_COURSE(new int[] {2989, 3009}, new int[] {3916, 3966}, false, true, true,
        false, false, false) {},
    EZONE_DONOR(new int[] {3342, 3385}, new int[] {9618, 9661}, false, true, true, false, false,
        false) {},
    ...
    public static boolean inLocation(Entity gc, Location location) {
      ...
      /*
       * if(gc instanceof Player) { Player p = (Player)gc; if(location == Location.TRAWLER_GAME) {
       * String state = FishingTrawler.getState(p); return (state != null &&
       * state.equals("PLAYING")); } else if(location == FIGHT_PITS_WAIT_ROOM || location ==
       * FIGHT_PITS) { String state = FightPit.getState(p), needed = (location ==
       * FIGHT_PITS_WAIT_ROOM) ? "WAITING" : "PLAYING"; return (state != null &&
       * state.equals(needed)); } else if(location == Location.SOULWARS) { return
       * (SoulWars.redTeam.contains(p) || SoulWars.blueTeam.contains(p) && SoulWars.gameRunning); }
       * else if(location == Location.SOULWARS_WAIT) { return SoulWars.isWithin(SoulWars.BLUE_LOBBY,
       * p) || SoulWars.isWithin(SoulWars.RED_LOBBY, p); } }
       */
  ...
  public static boolean goodDistance(int objectX, int objectY, int playerX, int playerY,
      int distance) {
