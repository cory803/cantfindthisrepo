...
public class Equipment extends ItemContainer {
  ...
  public boolean wearingHalberd() {
    ItemDefinition def =
        ItemDefinition.forId(getPlayer().getEquipment().getItems()[Equipment.WEAPON_SLOT].getId());
  ...
  /**
   * Gets the amount of item of a type a player has, for example, gets how many Zamorak items a
   * player is wearing for GWD
   * 
   * @param p The player
