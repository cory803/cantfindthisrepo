...
public class PriceChecker extends ItemContainer {
  ...
  public PriceChecker refreshItems() {
    ...
    if (itemFound) {
      ...
      getPlayer().getPacketSender().sendString(18413,
          "Click an item in your inventory to view it's wealth.");
    }
  ...
  @Override
  public PriceChecker switchItem(ItemContainer to, Item item, int slot, boolean sort,
      boolean refresh) {
  ...
  private static final int frames[][] = {{0, 18353, 18246}, {1, 18356, 18500}, {2, 18359, 18501},
      ...
      {8, 18377, 18507}, {9, 18380, 18508}, {10, 18383, 18509}, {11, 18386, 18510},
      {12, 18389, 18511}, {13, 18392, 18512}, {14, 18395, 18513}, {15, 18398, 18514},
      {16, 18401, 18515}, {17, 18404, 18516}, {18, 18407, 18517}, {19, 18410, 18518}};
