...
/**
 * This file manages a player's appearance and properties, such as head hints, gender, prayer head
 * hints, etc.
 * 
 * @author relex lawl
 */
...
public class Appearance {
  ...
  /**
   * Gets the look array, which is an array with 13 elements describing the look of a player.
   * 
   ...
   */
  public static final int HAIR_COLOUR = 8, TORSO_COLOUR = 9, LEG_COLOUR = 10, FEET_COLOUR = 11,
      SKIN_COLOUR = 12, HEAD = 1, CHEST = 2, ARMS = 3, HANDS = 4, LEGS = 5, FEET = 6, BEARD = 7,
      GENDER = 0;
}
