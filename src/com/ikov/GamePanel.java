...
public class GamePanel extends JFrame {
    ...
    gl_contentPane.setHorizontalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
        .addGroup(gl_contentPane.createSequentialGroup()
            .addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
                .addComponent(playersOnlineLabel).addComponent(memoryLabel)
                .addComponent(cycleTimeLabel).addComponent(maxMemoryLabel)
                .addComponent(maxCycleLabel).addComponent(tasksLabel).addComponent(taskCycleLabel)
                .addComponent(logoutCycleLabel).addComponent(loginCycleLabel)
                .addComponent(minigameCycleLabel).addComponent(entityUpdateLabel)
  ...
  public void addWorldCycle(long loginCycle, long logoutCycle, long minigameCycle,
      long entityUpdateCycle) {
