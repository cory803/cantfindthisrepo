      ...
      case "forumpromote":
        if (!GameSettings.FORUM_DATABASE_CONNECTIONS) {
          player.getPacketSender()
              .sendMessage("Forum database connections are currently turned off.");
          return;
        }
        if (!player.getForumDelay().elapsed(20000)) {
          player.getPacketSender()
              .sendMessage("Please wait another 20 seconds before connecting to the forum...");
          return;
        }
        ...
        try {
          ...
          if (current_rank_id != ForumDatabase.regular_donator
            ...
            player.getPacketSender()
                .sendMessage("This player has a rank on the forum that is not supported.");
            return;
          ...
          if (ForumDatabase.check_has_username(other_player_name)) {
            ...
            player.getPacketSender().sendMessage(
                "You have given " + other_player_name + " the rank Wiki Editor on the forum.");
          } else {
            player.getPacketSender()
                .sendMessage("This player does not have a forum account under this name.");
          }
      ...
      case "forumdemote":
        ...
        try {
          ...
          if (current_rank_id != ForumDatabase.wiki_editor) {
            player.getPacketSender()
                .sendMessage("This player does not have Wiki Editor on the forum.");
            return;
          } else if (current_rank_id == ForumDatabase.banned) {
            player.getPacketSender().sendMessage("This forum account is banned.");
            return;
          ...
          if (ForumDatabase.check_has_username(other_player_name)) {
            ...
            player.getPacketSender().sendMessage("You have demoted " + other_player_name
                + " from the rank Wiki Editor on the forum.");
          } else {
            player.getPacketSender()
                .sendMessage("This player does not have a forum account under this name.");
          }
      ...
      case "promote":
        ...
        if (target == null) {
          ...
          if (target.getRights() == PlayerRights.PLAYER) {
            ...
            player.getPacketSender().sendMessage(
                "You have given " + wholeCommand.substring(8) + " the rank Wiki Editor!");
            target.getPacketSender().sendRights();
          } else {
            player.getPacketSender()
                .sendMessage("You can't promote someone who already has a rank.");
          }
        }
        break;
      case "demote":
        ...
        if (target2 == null) {
          ...
          if (target2.getRights() == PlayerRights.WIKI_EDITOR) {
            ...
            player.getPacketSender()
                .sendMessage("You can't demote someone who is not a wiki editor.");
          }
        }
        break;
    }
