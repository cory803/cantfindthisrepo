...
public class BonusExperienceTask extends Task {
	...
	public void execute() {
		...
		if(newMinutes < 0) {
			...
			player.getPacketSender().sendMessage("<img=4> <col=330099>You have "+player.getMinutesBonusExp()+" minutes of bonus experience left.");
			msg = 0;
		}
		msg++;
	}
	...
	public static void addBonusXp(final Player p, int minutes) {
		...
		p.getPacketSender().sendMessage("<img=4> <col=330099>You have "+p.getMinutesBonusExp()+" minutes of bonus experience left.");
		if(startEvent) {
