...
/**
 * This packet listener is called when a player is doing something relative to their friends or
 * ignore list, such as adding or deleting a player from said list.
 * 
 * @author relex lawl
 */
    ...
    try {
      ...
      switch (packet.getOpcode()) {
        ...
        case REMOVE_IGNORE_OPCODE:
          ...
          break;
        case SEND_PM_OPCODE:
          Player friend = World.getPlayerByName(
              Misc.formatText(NameUtils.longToString(username)).replaceAll("_", " "));
