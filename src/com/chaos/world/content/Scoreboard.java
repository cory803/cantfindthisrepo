...
public final class Scoreboard {
	...
	public static void open(Player player, int type) {
		...
		switch (type) {
		case 1:
			player.getPacketSender().sendString(6399, "Chaos's Top PK'ers");
			streakList = PKERS;
			break;
		case 2:
			player.getPacketSender().sendString(6399, "Chaos's Top Killstreaks");
			streakList = KILLSTREAKS;
			break;
		case 3:
			player.getPacketSender().sendString(6399, "Chaos's Top Skillers");
			streakList = TOP_EXP;
			break;
		case 4:
			player.getPacketSender().sendString(6399, "Chaos's Tournament Leaders");
