package com.chaos.world.content.combat.weapon;
...
import com.chaos.engine.task.impl.ToxicStaffOfDeadSpecialAttackTask;
...
public enum CombatSpecial {
				...
				public void onHit(int damage, boolean accurate) {
					if (target.isPlayer() && accurate) {
						...
						player.getPacketSender()
								.sendMessage("Your hammer forces some of your opponent'sdefences to break.");
					}
				}
			};
		}
	...
	DRAGON_CLAWS(new int[] { 14484 }, 50, 1.7, 1.15, CombatType.MELEE, WeaponInterface.CLAWS) {
		@Override
		public CombatContainer container(Player player, Character target) {
