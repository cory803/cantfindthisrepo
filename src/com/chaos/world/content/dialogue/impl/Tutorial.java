package com.chaos.world.content.dialogue.impl;
	...
	public static Dialogue get(Player p, int stage) {
			...
			dialogue = new Dialogue() {
				...
				public String[] dialogue() {
					return new String[] { "Ah, a wise choice indeed! So let's get you started out,",
							...
							"listening to me, I'll give you a @red@powerful Sword@bla@ for your",
			...
			dialogue = new Dialogue() {
				...
				public String[] dialogue() {
					return new String[] { "You can earn money doing many different things in",
							"Chaos. For example, see those Thieving stalls infront of ",
							"you? You can steal items from them and sell them to the", "General Store." };
				};
			...
			dialogue = new Dialogue() {
				...
				public String[] dialogue() {
					return new String[] { "Enough of the boring stuff, let's show you some creatures!",
							"There are a bunch of bosses to fight in Chaos.",
							"Every boss drops unique and good gear when killed.", "One example is Nomad!" };
				};
		...
		case 8:
			dialogue = new Dialogue() {
				...
				@Override
				public String[] dialogue() {
					return new String[] { "Chaos also has a lot of enjoyable minigames.",
		...
		case 10:
			dialogue = new Dialogue() {
				...
				@Override
				public String[] dialogue() {
					return new String[] { "To receive a Donator rank, you'd need to claim",
							"scrolls worth at least $10 (for the Donator rank).",
		...
		case 11:
			dialogue = new Dialogue() {
				...
				@Override
				public String[] dialogue() {
					return new String[] { "Chaos is a competitive game. Next to you is a scoreboard",
			...
			dialogue = new Dialogue() {
				...
				public String[] dialogue() {
					return new String[] { "If you have any more questions, simply use the ::help",
							...
							"other players for help there too. Have fun playing Chaos!" };
				};
					...
					if (ConnectionHandler.getStarters(p.getHostAddress()) <= GameSettings.MAX_STARTERS_PER_IP) {
						if (p.getGameModeAssistant().isIronMan()) {
							p.getInventory().add(995, 10000).add(1153, 1).add(1115, 1).add(1067, 1).add(1323, 1)
									...
									.add(558, 50).add(557, 50).add(555, 50).add(1351, 1).add(1265, 1).add(1712, 1)
									.add(11118, 1).add(1007, 1).add(1061, 1).add(330, 100).add(16127, 1);
						} else {
							p.getInventory().add(995, 5000000).add(1153, 1).add(1115, 1).add(1067, 1).add(1323, 1)
									.add(1191, 1).add(841, 1).add(882, 1000).add(1167, 1).add(1129, 1).add(1095, 1)
									.add(1063, 1).add(579, 1).add(577, 1).add(1011, 1).add(1379, 1).add(556, 1000)
									.add(558, 1000).add(557, 1000).add(555, 1000).add(1351, 1).add(1265, 1).add(1712, 1)
									.add(11118, 1).add(1007, 1).add(1061, 1).add(386, 100).add(16127, 1);
						}
					...
					TaskManager.submit(new Task(20, p, false) {
						...
						protected void execute() {
							if (p != null && p.isRegistered()) {
								...
								p.getPacketSender().sendMessage("<img=4> @blu@Join 'Chaos' clan chat for help!");
							}
							stop();
						}
					});
			...
			dialogue = new Dialogue() {
				...
				public String[] dialogue() {
					return new String[] { "Before you start your tutorial,",
							...
							"This will protect you from hackers while you play Chaos.",
		...
		case 16:
			dialogue = new Dialogue() {
				...
				@Override
				public String[] dialogue() {
					return new String[] { "Great!", "Now that you are protected we can continue on...",
		...
		case 17:
			dialogue = new Dialogue() {
				...
				@Override
				public String[] dialogue() {
					return new String[] { "Before you continue...", "We require that everyone sets an account pin.",
							"This will protect you from hackers while you play Chaos.",
							"Make sure you write it down!" };
				};
