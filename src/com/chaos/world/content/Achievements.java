...
public class Achievements {
	...
	public enum AchievementData {
		...
		FLETCH_450_RUNE_BOLTS(Difficulty.MEDIUM, "Fletch 450 Rune Bolts", 37052, new int[] {14, 450 }),
		...
		CHOP_750_YEW_LOGS(Difficulty.HARD, "Cut 750 Yew Logs", 37072, new int[] { 26, 750 }),
		BURN_500_YEW_LOGS(Difficulty.HARD, "Burn 500 Yew Logs", 37073, new int[] { 27, 500 }),
		FISH_700_MANTA(Difficulty.HARD, "Fish 100 Manta Ray", 37074, new int[] { 28, 700 }),
		COOK_500_MANTA(Difficulty.HARD, "Cook 100 Manta Ray", 37075, new int[] { 29, 500 }),
		MINE_400_ADDY(Difficulty.HARD, "Mine 300 Adamant Ores", 37076, new int[] { 30, 300 }),
		CRAFT_1000_DIAMOND_GEMS(Difficulty.HARD, "Craft 750 Diamond Gems", 37077, new int[] { 31, 750 }),
		ENCHANT_1000_BOLTS(Difficulty.HARD, "Enchant 1000 Bolts", 37078, new int[] { 32, 1000 }),
		HIGH_ALCH_ITEMS(Difficulty.HARD, "High Alch 1000 Items", 37079, new int[] { 33, 1000 }),
		STEAL_5000_SCIMITARS(Difficulty.HARD, "Steal 2,000 Times", 37080, new int[] { 34, 2000 }),
		FIRE_5000_CANNON_BALLS(Difficulty.HARD, "Fire 3000 Cannon Balls", 37081, new int[] { 35, 3000 }),
		MIX_100_OVERLOAD_POTIONS(Difficulty.HARD, "Mix 100 Overload Potions", 37082, new int[] { 36, 100 }),
		COMPLETE_AN_ELITE_SLAYER_TASK(Difficulty.HARD, "Complete an Elite Slayer Task", 37083, null),
		DEAL_HARD_DAMAGE_USING_MELEE(Difficulty.HARD, "Deal 5M Melee Damage", 37084, new int[] { 37, 5000000 }),
		DEAL_HARD_DAMAGE_USING_RANGED(Difficulty.HARD, "Deal 5M Ranged Damage", 37085, new int[] { 38, 5000000 }),
		DEAL_HARD_DAMAGE_USING_MAGIC(Difficulty.HARD, "Deal 5M Magic Damage", 37086, new int[] { 39, 5000000 }),
		DEFEAT_JAD(Difficulty.HARD, "Defeat Jad", 37087, null),
		DEFEAT_BANDOS_AVATAR(Difficulty.HARD, "Defeat Bandos Avatar", 37088, null),
		DEFEAT_GENERAL_GRAARDOR(Difficulty.HARD, "Defeat General Graardor", 37089, null),
		DEFEAT_KREE_ARRA(Difficulty.HARD, "Defeat Kree'Arra", 37090, null),
		DEFEAT_COMMANDER_ZILYANA(Difficulty.HARD, "Defeat Commander Zilyana", 37091, null),
		DEFEAT_KRIL_TSUTSAROTH(Difficulty.HARD, "Defeat K'ril Tsutsaroth", 37092, null),
		DEFEAT_THE_CORPOREAL_BEAST(Difficulty.HARD, "Defeat The Corporeal Beast", 37093, null),
		DEFEAT_NEX(Difficulty.HARD, "Defeat Nex", 37094, null),
		DEFEAT_30_PLAYERS(Difficulty.HARD, "Defeat 30 Players", 37095, new int[] { 40, 30 }),

		RUNECRAFT_8000_BLOOD_RUNES(Difficulty.ELITE, "Runecraft 6000 Blood Runes", 37097, new int[] { 41, 6000 }),
		CUT_5000_MAGIC_LOGS(Difficulty.ELITE, "Cut 2500 Magic Logs", 37098, new int[] { 42, 2500 }),
		BURN_2500_MAGIC_LOGS(Difficulty.ELITE, "Burn 2500 Magic Logs", 37099, new int[] { 43, 2500 }),
		FISH_2000_ROCKTAILS(Difficulty.ELITE, "Fish 1500 Rocktails", 37100, new int[] { 44, 1500 }),
		COOK_1000_ROCKTAILS(Difficulty.ELITE, "Cook 1000 Rocktails", 37101, new int[] { 45, 1000 }),
		MINE_2000_RUNITE_ORES(Difficulty.ELITE, "Mine 1000 Runite Ores", 37102, new int[] { 46, 1000 }),
		SMELT_1000_RUNE_BARS(Difficulty.ELITE, "Smelt 1000 Rune Bars", 37103, new int[] { 47, 1000 }),
		HARVEST_1000_TORSTOLS(Difficulty.ELITE, "Harvest 1000 Torstols", 37104, new int[] { 48, 1000 }),
		INFUSE_500_STEEL_TITAN_POUCHES(Difficulty.ELITE, "Infuse 500 Steel Titans", 37105, new int[] { 49, 500 }),
		CATCH_100_KINGLY_IMPLINGS(Difficulty.ELITE, "Catch 100 Kingly Imps", 37106, new int[] {50, 100 }),
		FLETCH_5000_RUNE_ARROWS(Difficulty.ELITE, "Fletch 5000 Rune Arrows", 37107, new int[] {51, 5000 }),
		CUT_AN_ONYX_STONE(Difficulty.ELITE, "Cut an Onyx Stone", 37108, null),
		REACH_MAX_EXP_IN_A_SKILL(Difficulty.ELITE, "Reach Max Exp in a Skill", 37109, null),
		HIT_700_WITH_SPECIAL_ATTACK(Difficulty.ELITE, "Hit 700 with Special Attack", 37110, new int[] { 52, 1 }),
		DEFEAT_10000_MONSTERS(Difficulty.ELITE, "Defeat 10,000 Monsters", 37111, new int[] { 53, 10000 }),
		DEFEAT_500_BOSSES(Difficulty.ELITE, "Defeat 500 Boss Monsters", 37112, new int[] { 54, 500 }),
		;
