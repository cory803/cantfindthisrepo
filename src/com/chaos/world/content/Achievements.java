...
public class Achievements {
	...
	public enum AchievementData {
		...
		FISH_700_MANTA(Difficulty.HARD, "Fish 100 Manta Ray", 37075, new int[] { 28, 700 }),
		COOK_500_MANTA(Difficulty.HARD, "Cook 100 Manta Ray", 37076, new int[] { 29, 500 }),
		...
		COMPLETE_AN_ELITE_SLAYER_TASK(Difficulty.HARD, "Complete an Elite Slayer Task", 37084, null),
		DEAL_HARD_DAMAGE_USING_MELEE(Difficulty.HARD, "Deal 5M Melee Damage", 37085, new int[] { 37, 5000000 }),
		DEAL_HARD_DAMAGE_USING_RANGED(Difficulty.HARD, "Deal 5M Ranged Damage", 37086, new int[] { 38, 5000000 }),
		DEAL_HARD_DAMAGE_USING_MAGIC(Difficulty.HARD, "Deal 5M Magic Damage", 37087, new int[] { 39, 5000000 }),
		...
		HARVEST_1000_TORSTOLS(Difficulty.ELITE, "Harvest 1000 Torstols", 37106, new int[] { 48, 1000 }),
