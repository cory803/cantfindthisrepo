...
public class Achievements {
	...
	public enum AchievementData {
        ...
        BURY_50_DRAGON_BONES(Difficulty.EASY, "Bury 50 dragon bones", 37038, new int[] { 4, 50 }),
        MIX_AN_OVERLOAD_POTION(Difficulty.EASY, "Make an Overload Potion", 37039, null),
		CHOP_250_MAPLE_LOGS(Difficulty.MEDIUM, "Cut 250 Maple Logs", 37040, new int[] { 5, 250 }),
		BURN_200_MAPLE_LOGS(Difficulty.MEDIUM, "Burn 200 Maple Logs", 37041, new int[] { 6, 200 }),
		FISH_100_SHARKS(Difficulty.MEDIUM, "Fish 100 sharks", 37042, new int[] { 7, 100 }),
		COOK_100_SHARKS(Difficulty.MEDIUM, "Cook 100 sharks", 37043, new int[] { 8, 100 }),
		MINE_200_COAL(Difficulty.MEDIUM, "Mine 200 Coal ores", 37044, new int[] { 9, 200 }),
		SMELT_50_MITH_BARS(Difficulty.MEDIUM, "Smelt 50 Mithril Bars", 37045, new int[] { 10, 50 }),
		HARVEST_10_TORSTOLS(Difficulty.MEDIUM, "Harvest 10 Torstols", 37046, new int[] { 11, 10 }),
		INFUSE_25_TITAN_POUCHES(Difficulty.MEDIUM, "Infuse 25 Steel Titans", 37047, new int[] { 12, 25 }),
		CATCH_5_KINGLY_IMPLINGS(Difficulty.MEDIUM, "Catch 5 Kingly Implings", 37048, new int[] {13, 5 }),
		COMPLETE_A_HARD_SLAYER_TASK(Difficulty.MEDIUM, "Complete a Hard Slayer Task", 37049, null),
		CRAFT_20_BLACK_DHIDE_BODIES(Difficulty.MEDIUM, "Craft 20 Black D'hide Bodies", 37050, new int[] {14, 20 }),
		FLETCH_450_RUNE_ARROWS(Difficulty.MEDIUM, "Fletch 450 Rune Arrows", 37051, new int[] {15, 450 }),
		STEAL_140_SCIMITARS(Difficulty.MEDIUM, "Pick-Pocket 150 times", 37052, new int[] {16, 150 }),
		BARB_AGILITY(Difficulty.MEDIUM, "Complete Barb Agility Course", 37053, null),
		CLIMB_50_AGILITY_OBSTACLES(Difficulty.MEDIUM, "Climb 50 Agility Obstacles", 37054, new int[] {17, 50 }),
		RUNECRAFT_500_NATS(Difficulty.MEDIUM, "Runecraft 500 Nature Runes", 37055, new int[] {18, 500 }),
		...
		LOW_ALCH_ITEMS(Difficulty.MEDIUM, "Low Alch 300 Items", 37067, new int[] { 25, 300 }),

		BURY_500_FROST_DRAGON_BONES(Difficulty.HARD, "Bury 500 Frost Dragon Bones", 37069, new int[] {26, 500 }),
		STEAL_5000_SCIMITARS(Difficulty.HARD, "Steal 2,000 Times", 37070, new int[] {27, 2000 }),
		FIRE_5000_CANNON_BALLS(Difficulty.HARD, "Fire 3000 Cannon Balls", 37071, new int[] {28, 3000 }),
		MIX_100_OVERLOAD_POTIONS(Difficulty.HARD, "Mix 100 Overload Potions", 37072, new int[] {29, 100 }),
		COMPLETE_AN_ELITE_SLAYER_TASK(Difficulty.HARD, "Complete an Elite Slayer Task", 37073, null),
		DEAL_HARD_DAMAGE_USING_MELEE(Difficulty.HARD, "Deal 5M Melee Damage", 37074, new int[] {30, 5000000 }),
		DEAL_HARD_DAMAGE_USING_RANGED(Difficulty.HARD, "Deal 5M Ranged Damage", 37075, new int[] {31, 5000000 }),
		DEAL_HARD_DAMAGE_USING_MAGIC(Difficulty.HARD, "Deal 5M Magic Damage", 37076, new int[] {32, 5000000 }),
		DEFEAT_JAD(Difficulty.HARD, "Defeat Jad", 37077, null),
		DEFEAT_BANDOS_AVATAR(Difficulty.HARD, "Defeat Bandos Avatar", 37078, null),
		DEFEAT_GENERAL_GRAARDOR(Difficulty.HARD, "Defeat General Graardor", 37079, null),
		DEFEAT_KREE_ARRA(Difficulty.HARD, "Defeat Kree'Arra", 37080, null),
		DEFEAT_COMMANDER_ZILYANA(Difficulty.HARD, "Defeat Commander Zilyana", 37081, null),
		DEFEAT_KRIL_TSUTSAROTH(Difficulty.HARD, "Defeat K'ril Tsutsaroth", 37082, null),
		DEFEAT_THE_CORPOREAL_BEAST(Difficulty.HARD, "Defeat The Corporeal Beast", 37083, null),
		DEFEAT_NEX(Difficulty.HARD, "Defeat Nex", 37084, null),
		DEFEAT_30_PLAYERS(Difficulty.HARD, "Defeat 30 Players", 37085, new int[] {33, 30 }),

		RUNECRAFT_8000_BLOOD_RUNES(Difficulty.ELITE, "Runecraft 6000 Blood Runes", 37087, new int[] {34, 6000 }),
		CUT_5000_MAGIC_LOGS(Difficulty.ELITE, "Cut 2500 Magic Logs", 37088, new int[] { 35, 2500 }),
		BURN_2500_MAGIC_LOGS(Difficulty.ELITE, "Burn 2500 Magic Logs", 37089, new int[] { 36, 2500 }),
		FISH_2000_ROCKTAILS(Difficulty.ELITE, "Fish 1500 Rocktails", 37090, new int[] { 37, 1500 }),
		COOK_1000_ROCKTAILS(Difficulty.ELITE, "Cook 1000 Rocktails", 37091, new int[] { 38, 1000 }),
		MINE_2000_RUNITE_ORES(Difficulty.ELITE, "Mine 1000 Runite Ores", 37092, new int[] { 39, 1000 }),
		SMELT_1000_RUNE_BARS(Difficulty.ELITE, "Smelt 1000 Rune Bars", 37093, new int[] { 40, 1000 }),
		HARVEST_1000_TORSTOLS(Difficulty.ELITE, "Harvest 1000 Torstols", 37094, new int[] { 41, 1000 }),
		INFUSE_500_STEEL_TITAN_POUCHES(Difficulty.ELITE, "Infuse 500 Steel Titans", 37095, new int[] { 42, 500 }),
		CRAFT_1000_DIAMOND_GEMS(Difficulty.ELITE, "Craft 750 Diamond Gems", 37096, new int[] { 43, 750 }),
		CATCH_100_KINGLY_IMPLINGS(Difficulty.ELITE, "Catch 100 Kingly Imps", 37097, new int[] {44, 100 }),
		FLETCH_5000_RUNE_ARROWS(Difficulty.ELITE, "Fletch 5000 Rune Arrows", 37098, new int[] {45, 5000 }),
		CUT_AN_ONYX_STONE(Difficulty.ELITE, "Cut an Onyx Stone", 37099, null),
		REACH_MAX_EXP_IN_A_SKILL(Difficulty.ELITE, "Reach Max Exp in a Skill", 37100, null),
		HIT_700_WITH_SPECIAL_ATTACK(Difficulty.ELITE, "Hit 700 with Special Attack", 37101, new int[] { 46, 1 }),
		DEFEAT_10000_MONSTERS(Difficulty.ELITE, "Defeat 10,000 Monsters", 37102, new int[] { 47, 10000 }),
		DEFEAT_500_BOSSES(Difficulty.ELITE, "Defeat 500 Boss Monsters", 37103, new int[] { 48, 500 }),
		;
