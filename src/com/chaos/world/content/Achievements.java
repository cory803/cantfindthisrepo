...
public class Achievements {
	...
	public enum AchievementData {
		...
		ADD_FRIEND(Difficulty.EASY, "Add a friend", 37024, null), //TODO
		GET_SLAYER_TASK(Difficulty.EASY, "Get a slayer task", 37025, null),
		SWITCH_SPELLBOOK(Difficulty.EASY, "Switch to another spellbook", 37026, null), //TODO
		SWITCH_PRAYBOOK(Difficulty.EASY, "Switch to the curse prayers", 37027, null), //TODO
		...
		BURY_50_DRAGON_BONES(Difficulty.MEDIUM, "Enter the Lottery 3 times", 37037, new int[] { 3, 50 }),
		FILL_WELL_OF_GOODWILL_50M(Difficulty.MEDIUM, "Pour 50M into the Well", 37038, new int[] { 4, 50000000 }),
		CHOP_250_MAPLE_LOGS(Difficulty.MEDIUM, "Cut 250 Maple Logs", 37039, new int[] { 5, 250 }),
		BURN_200_MAPLE_LOGS(Difficulty.MEDIUM, "Burn 200 Maple Logs", 37040, new int[] { 6, 200 }),
		FISH_100_SHARKS(Difficulty.MEDIUM, "Fish 100 sharks", 37041, new int[] { 7, 100 }),
		COOK_100_SHARKS(Difficulty.MEDIUM, "Cook 100 sharks", 37042, new int[] { 8, 100 }),
		MINE_200_COAL(Difficulty.MEDIUM, "Mine 200 Coal ores", 37043, new int[] { 9, 200 }),
		SMELT_50_MITH_BARS(Difficulty.MEDIUM, "Smelt 50 Mithril Bars", 37044, new int[] { 10, 50 }),
