package com.chaos.world.content.grandexchange;
...
import com.chaos.world.content.grandexchange.GrandExchangeOffer.OfferType;
		...
		try {
			...
			if (count > 0) {
				for (int i = 0; i < count; i++) {
					...
					OFFERS[arrayIndex] = new GrandExchangeOffer(id, quantity, listedBy, arrayIndex, pricePerItem, box,
							amountFinished, coinsCollect, itemCollect, failedAttempts, type, updateStateOrdinal);
				}
			}
