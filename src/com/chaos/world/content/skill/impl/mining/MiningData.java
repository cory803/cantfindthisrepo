...
public class MiningData {
	...
	public static enum Ores {
		...
		COPPER(new int[] { 9708, 9709, 9710, 11936, 11960, 11961, 11962, 11189, 11190, 11191, 29231, 29230, 2090 }, 1, 17.5, 436, 4, 4),
		TIN(new int[] { 9714, 9715, 9716, 11933, 11957, 11958, 11959, 11186, 11187, 11188, 2094, 29227, 29229 }, 1, 17.5, 438, 4, 4),
		IRON(new int[] { 7455, 7489, 14856, 9717, 9718, 9719, 2093, 2092, 11954, 11955, 11956, 29221, 29222, 29223 }, 15, 35, 440, 5, 5),
		SILVER(new int[] { 2100, 2101, 29226, 29225, 11948, 11949 }, 20, 40, 442, 5, 7),
		COAL(new int[] { 14851, 14852, 14850, 2097, 5770, 29216, 29215, 29217, 11965, 11964, 11963, 11930, 11931, 11932 }, 30, 50, 453, 5, 7),
		GOLD(new int[] { 7491, 9720, 9721, 9722, 11951, 11183, 11184, 11185, 2099 }, 40, 60, 444, 5, 10),
		MITHRIL(new int[] { 7459, 14855, 14853, 14854, 25370, 25368, 5786, 5784, 11942, 11943, 11944, 11945, 11946, 29236, 11947, 11942, 11943 }, 55, 80, 447, 6, 11),
		ADAMANTITE(new int[] { 7493, 14862, 11941, 11939, 29233, 29235 }, 70, 95, 449, 7, 14),
