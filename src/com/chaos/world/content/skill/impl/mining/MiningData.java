...
public class MiningData {
	...
	public static enum Ores {
		...
		Pure_essence(new int[] { 24445 }, 17, 30, 7936, 3, -1),
		Clay(new int[] { 9711, 9712, 9713, 15503, 15504, 15505 }, 1, 5, 434, 3, 2),
		Copper(new int[] { 9708, 9709, 9710, 11936, 11960, 11961, 11962, 11189, 11190, 11191, 29231, 29230, 2090 }, 1, 18, 436, 4, 4),
		Tin(new int[] { 9714, 9715, 9716, 11933, 11957, 11958, 11959, 11186, 11187, 11188, 2094, 29227, 29229 }, 1, 18, 438, 4, 4),
