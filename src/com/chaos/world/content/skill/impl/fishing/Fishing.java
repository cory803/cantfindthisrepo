...
public class Fishing {
	...
	public enum Spot {
		...
		RESOURCE_ROCKTAIL(321, new int[] { 15271, 15270 }, 309, 25, new int[] { 89, 89 }, false, new int[] { 480 }, 623),

		RESOURCE_KARAM(322, new int[] { 3143, 3142 }, 305, -1, new int[] { 65, 65 }, false, new int[] { 225 }, 621);
