...
//                break;
            ...
            case -10459:
                ...
                player.forceChat("[RuneLive]e My title is: None.");
            ...
            case -10458:
                ...
                player.forceChat("[RuneLive]e I have played for: " + Misc.getMinutesPlayed(player) + " minutes.");
                player.getQuickChat().reset();
                break;
            case -10457:
                if (!player.getQuickChat().elapsed(2500)) {
            ...
            case -10456:
                ...
                player.forceChat("[RuneLive]e My donator rank is: "+player.getDonatorRights().getTitle()+".");
                player.getQuickChat().reset();
                break;
            case -10454:
                if (!player.getQuickChat().elapsed(2500)) {
                ...
                player.forceChat("[RuneLive]e I have "+player.getPointsHandler().getPkPoints()+" pk points.");
                player.getQuickChat().reset();
                break;
            case -10453:
                if (!player.getQuickChat().elapsed(2500)) {
                ...
                player.forceChat("[RuneLive]e I have "+player.getPointsHandler().getVotingPoints()+" vote points.");
                player.getQuickChat().reset();
                break;
            case -10452:
                if (!player.getQuickChat().elapsed(2500)) {
                ...
                player.forceChat("[RuneLive]e I have "+player.getPointsHandler().getSlayerPoints()+" slayer points.");
                player.getQuickChat().reset();
                break;
            case -10451:
                if (!player.getQuickChat().elapsed(2500)) {
                ...
                player.forceChat("[RuneLive]e I have "+player.getPointsHandler().getCommendations()+" commendations.");
                player.getQuickChat().reset();
                break;
            case -10450:
                if (!player.getQuickChat().elapsed(2500)) {
                ...
                player.forceChat("[RuneLive]e I have "+player.getPointsHandler().getDungeoneeringTokens()+" dungeoneering tokens.");
                player.getQuickChat().reset();
                break;
            case -10448:
                if (!player.getQuickChat().elapsed(2500)) {
                ...
                player.forceChat("[RuneLive]e My Kill/Death ration is: "+kdr+".");
                player.getQuickChat().reset();
                break;
            case -10447:
                if (!player.getQuickChat().elapsed(2500)) {
                ...
                player.forceChat("[RuneLive]e I have a total of "+player.getPlayerKillingAttributes().getPlayerKills()+" kills.");
                player.getQuickChat().reset();
                break;
            case -10446:
                if (!player.getQuickChat().elapsed(2500)) {
                ...
                player.forceChat("[RuneLive]e I have a total of "+player.getPlayerKillingAttributes().getPlayerDeaths()+" deaths.");
                player.getQuickChat().reset();
                break;
            case -10445:
                if (!player.getQuickChat().elapsed(2500)) {
                ...
                player.forceChat("[RuneLive]e My killstreak is: "+player.getPlayerKillingAttributes().getPlayerKillStreak()+".");
                player.getQuickChat().reset();
                break;
            case -10444:
                if (!player.getQuickChat().elapsed(2500)) {
                ...
                player.forceChat("[RuneLive]e I have won "+player.getDueling().arenaStats[0]+" duels.");
                player.getQuickChat().reset();
                break;
            case -10443:
                if (!player.getQuickChat().elapsed(2500)) {
                ...
                player.forceChat("[RuneLive]e I have lost "+player.getDueling().arenaStats[1]+" duels.");
                player.getQuickChat().reset();
                break;
            case -10440:
                if (!player.getQuickChat().elapsed(2500)) {
...
//                    player.forceChat("[RuneLive]e I currently do not have a slayer task.");
//                } else {
//                    player.forceChat("[RuneLive]e My slayer task is: "+ Misc.formatText(player.getSlayer().getSlayerMaster().toString().toLowerCase().replaceAll("_", " "))+"s.");
//                }
//                player.forceChat("[RuneLive]e My slayer task is: "+ Misc.formatText(player.getSlayer().getSlayerMaster().toString().toLowerCase().replaceAll("_", " "))+".");
//                player.getQuickChat().reset();
                break;
