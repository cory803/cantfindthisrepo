package com.runelive.world.content.skill.impl.farming.patch;
...
import com.runelive.world.content.skill.impl.farming.FarmingConstants;
import com.runelive.world.content.skill.impl.farming.FarmingManager;
import com.runelive.world.content.skill.impl.farming.attributes.GrowthState;
import com.runelive.world.content.skill.impl.farming.attributes.PatchAttribute;
import com.runelive.world.content.skill.impl.farming.seed.AllotmentSeedType;
import com.runelive.world.content.skill.impl.farming.seed.FlowerSeedType;
import com.runelive.world.content.skill.impl.farming.seed.SeedClass;
import com.runelive.world.content.skill.impl.farming.seed.SeedType;
				...
				if (System.currentTimeMillis() - timePlanted 
					...
					if (isFullyGrown()) {
						if (getSeedType().getSeedClass() == SeedClass.BUSHES) {
							...
							player.getPacketSender().sendMessage("One of your crops is now fully grown!", true);
							stop();
						}
					}
				}
