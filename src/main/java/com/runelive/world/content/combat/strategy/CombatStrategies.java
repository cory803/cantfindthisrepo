...
import com.runelive.world.content.combat.strategy.impl.kraken.Kraken;
import com.runelive.world.content.combat.strategy.impl.kraken.Tentacles;
...
public class CombatStrategies {
	...
	public static void init() {
		...
		STRATEGIES.put(8549, new Phoenix());
