...
public class RegionInstance {
	...
	public enum RegionInstanceType {
		PHOENIX, CERBERUS_CAVE, WILDKEY_ZONE, BOSS_SYSTEM, BARROWS, GRAVEYARD, FIGHT_CAVE, WARRIORS_GUILD, NOMAD, RECIPE_FOR_DISASTER, CONSTRUCTION_HOUSE, CONSTRUCTION_DUNGEON, ZULRAH_PIT, KRAKEN;
	}
