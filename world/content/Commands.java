...
public class Commands {
	...
	public static void open(Player player) {
		try {
			...
			player.getPacketSender().sendString(55050, "@or3@ - @whi@ ::cpuban [player]");
			player.getPacketSender().sendString(55051, "@or3@ - @whi@ ::host [player]");
			player.getPacketSender().sendString(55052, "@or3@ - @whi@ ::gold [player]");
			/*player.getPacketSender().sendString(55053, "@or3@ - @whi@ ");
