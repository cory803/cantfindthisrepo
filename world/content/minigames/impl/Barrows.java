...
import com.strattus.engine.task.impl.CeilingCollapseTask;
		...
		case 10284:
			...
			if (player.getMinigameAttributes().getBarrowsMinigameAttributes().getBarrowsData()[player.getMinigameAttributes().getBarrowsMinigameAttributes().getRandomCoffin()][1] == 0) {
				...
				if(player.getInventory().getFreeSlots() < 2) {
					player.getPacketSender().sendMessage("You need at least 2 free inventory slots to loot this chest.");
					return true;
				}
				resetBarrows(player);
