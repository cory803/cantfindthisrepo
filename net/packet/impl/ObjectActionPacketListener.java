...
import com.ikov.model.input.impl.EnterAmountOfLogsToAdd;
...
import com.ikov.world.content.WildernessObelisks;
...
import com.ikov.world.content.skill.impl.fishing.Fishing.Spot;
...
import com.ikov.world.content.skill.impl.mining.MiningData;
import com.ikov.world.content.skill.impl.mining.Prospecting;
import com.ikov.world.content.skill.impl.runecrafting.Runecrafting;
import com.ikov.world.content.skill.impl.runecrafting.RunecraftingData;
...
import com.ikov.world.content.skill.impl.thieving.Stalls;
import com.ikov.world.content.skill.impl.woodcutting.Woodcutting;
import com.ikov.world.content.skill.impl.woodcutting.WoodcuttingData;
...
public class ObjectActionPacketListener implements PacketListener {
	...
	private static void firstClick(final Player player, Packet packet) {
		...
		if(id > 0 && id != 6 && id != 1765 && id != 1306 && id != 411 && id != 2213 && !Dungeoneering.doingDungeoneering(player) && !RegionClipping.objectExists(gameObject)) {
	...
	private static void secondClick(final Player player, Packet packet) {
		...
		player.setInteractingObject(gameObject).setWalkToTask(new WalkToTask(player, position, gameObject.getSize(), new FinalizedMovementTask() {
			public void execute() {
				...
				case 4705:
					Stalls.stealFromStall(player, 75, 22500, new Item(995, Misc.getRandom(40000)), "You stole some coins.", true);
					break;
				case 4706:
