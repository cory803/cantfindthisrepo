...
import com.strattus.model.input.impl.EnterClanChatToJoin;
import com.strattus.model.input.impl.EnterSyntaxToBankSearchFor;
...
import com.strattus.world.content.Emotes;
import com.strattus.world.content.EnergyHandler;
import com.strattus.world.content.ExperienceLamps;
import com.strattus.world.content.ItemsKeptOnDeath;
...
import com.strattus.world.content.dialogue.DialogueOptions;
...
import com.strattus.world.content.skill.ChatboxInterfaceSkillAction;
import com.strattus.world.content.skill.impl.construction.Construction;
...
import com.strattus.world.content.skill.impl.herblore.IngridientsBook;
...
public class ButtonClickPacketListener implements PacketListener {
	...
	public void handleMessage(Player player, Packet packet) {
		...
		case 11014:
			...
			break;
		case -26333:
			player.getPacketSender().sendString(1, "www.strattus.net/forum/");
			player.getPacketSender().sendMessage("Attempting to open: strattus.net/forum");
			break;
		case -26332:
			player.getPacketSender().sendString(1, "http://www.strattus.net/forum/index.php?/forum/6-knowledge-base/");
			player.getPacketSender().sendMessage("Attempting to open: strattus.net/rules");
			break;
		case -26331:
			player.getPacketSender().sendString(1, "www.strattus.net/store/");
			player.getPacketSender().sendMessage("Attempting to open: strattus.net/store");
			break;
		case -26330:
			player.getPacketSender().sendString(1, "www.strattus.net/vote/");
			player.getPacketSender().sendMessage("Attempting to open: strattus.net/vote");
			break;
		case -26329:
			player.getPacketSender().sendString(1, "www.strattus.net/hiscores/");
			player.getPacketSender().sendMessage("Attempting to open: strattus.net/hiscores");
			break;
		case -26328:
			player.getPacketSender().sendString(1, "www.strattus.net/forum/");
			player.getPacketSender().sendMessage("Attempting to open: strattus.net/report");
			break;
		case -26337:
